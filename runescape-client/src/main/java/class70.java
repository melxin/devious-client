...
public class class70 {
	...
	static {
		field885 = new BigInteger("10001", 16);
		field887 = new BigInteger("", 16);
	}
	...
	static double method2045(int var0, int var1, int var2) {
		...
		if (var3 > 0.0D && var3 < 1.0D) {
			...
			case 9:
				return var3 < 0.5D ? 4.0D * var3 * var3 * var3 : 1.0D - Math.pow(2.0D + -2.0D * var3, 3.0D) / 2.0D;
			case 10:
			...
			case 18:
				return var3 < 0.5D ? Math.pow(2.0D, 20.0D * var3 + 10.0D) / 2.0D : (2.0D - Math.pow(2.0D, 10.0D + var3 * -20.0D)) / 2.0D;
			case 19:
			...
			case 22:
				var5 = 1.70158D;
				var7 = 2.70158D;
				return var3 * 2.70158D * var3 * var3 - 1.70158D * var3 * var3;
			case 23:
				var5 = 1.70158D;
				var7 = 2.70158D;
			...
			case 24:
				var5 = 1.70158D;
				var7 = 2.5949095D;
				return var3 < 0.5D ? Math.pow(2.0D * var3, 2.0D) * (7.189819D * var3 - 2.5949095D) / 2.0D : (Math.pow(var3 * 2.0D - 2.0D, 2.0D) * (2.5949095D + (var3 * 2.0D - 2.0D) * 3.5949095D) + 2.0D) / 2.0D;
			case 25:
