...
public class LoginScreenAnimation {
	...
	final void method2404(int var1) {
		...
		for (var7 = 256 - var1; var7 < 256; ++var7) {
			this.field1243[var7] = (int)(Math.sin((double)this.field1238 / 14.0D) * 16.0D + Math.sin((double)this.field1238 / 15.0D) * 14.0D + Math.sin((double)this.field1238 / 16.0D) * 12.0D);
			++this.field1238;
		}
	...
	final void method2408(IndexedSprite var1) {
		...
		for (var2 = 0; var2 < 5000; ++var2) {
			...
			this.field1250[var3] = (int)(Math.random() * 256.0D);
		}
