...
public final class Client extends GameEngine implements Usernamed, OAuthApi, class312 {
	...
	static {
		...
		field778 = new int[]{768, 1024, 1280, 512, 1536, 256, 0, 1792};
						...
						for (int var17 = 0; var17 < 100; ++var17) {
							...
							if (var7 > 0) {
								...
								if (ApproximateRouteStrategy.NetCache_currentResponse == null) {
									...
									ModeWhere.NetCache_responseArchiveBuffer.method9050(var12);
								...
								if (var8 == ModeWhere.NetCache_responseArchiveBuffer.offset) {
									if (ApproximateRouteStrategy.NetCache_currentResponse.key == 16711935L) {
										...
										if (var10 != ApproximateRouteStrategy.NetCache_currentResponse.crc) {
											...
											NetCache.field4282 = (byte)((int)(Math.random() * 255.0D + 1.0D));
											var1 = false;
											break label240;
										}
	...
	final void doCycleLoggedOut() {
		...
		try {
			...
			if (loginState == 5) {
				...
				var31.offset = 0;
				var31.writeByte(1);
				var31.method9050(var32[0]);
				var31.method9050(var32[1]);
				var31.method9050(var32[2]);
				var31.method9050(var32[3]);
				var31.writeLong(MusicPatchNode.field3475);
				if (gameState == 40) {
					var31.method9050(FloorOverlayDefinition.field2268[0]);
					var31.method9050(FloorOverlayDefinition.field2268[1]);
					var31.method9050(FloorOverlayDefinition.field2268[2]);
					var31.method9050(FloorOverlayDefinition.field2268[3]);
				} else {
					if (gameState == 50) {
						var31.writeByte(class138.field1610.rsOrdinal());
						var31.method9050(GameObject.field2850);
					} else {
						...
						case 4:
							...
							break;
						case 1:
							var31.method9050(class10.clientPreferences.method2459(Login.Login_username));
							break;
						case 2:
							var31.offset += 4;
						case 3:
				...
				var35.packetBuffer.method9050(214);
				var35.packetBuffer.method9050(1);
				...
				var35.packetBuffer.method9050(class156.field1726);
				if (field512 > 213) {
				...
				var35.packetBuffer.writeByte(clientType);
				var35.packetBuffer.method9050(0);
				var35.packetBuffer.method9050(Language.archive17.hash);
				var35.packetBuffer.method8961(class180.archive8.hash);
				var35.packetBuffer.method8962(0);
				var35.packetBuffer.method9050(ViewportMouse.field2770.hash);
				var35.packetBuffer.method8919(class291.archive20.hash);
				var35.packetBuffer.method9050(class17.archive15.hash);
				var35.packetBuffer.method9050(class53.archive10.hash);
				var35.packetBuffer.method8961(BuddyRankComparator.archive4.hash);
				var35.packetBuffer.method8962(Language.field4347.hash);
				var35.packetBuffer.method8961(class350.archive18.hash);
				var35.packetBuffer.method9050(MouseRecorder.archive2.hash);
				var35.packetBuffer.method9050(class466.field4812.hash);
				var35.packetBuffer.method8919(class310.archive13.hash);
				var35.packetBuffer.method8961(Actor.archive7.hash);
				var35.packetBuffer.method9050(ReflectionCheck.archive6.hash);
				var35.packetBuffer.method8961(class33.archive12.hash);
				var35.packetBuffer.method8919(FontName.archive11.hash);
				var35.packetBuffer.method9050(GrandExchangeOffer.archive14.hash);
				var35.packetBuffer.method8961(ChatChannel.archive19.hash);
				var35.packetBuffer.method8962(LoginScreenAnimation.field1244.hash);
				var35.packetBuffer.method8961(class305.archive9.hash);
			...
			if (loginState == 9 && this.field652.method37()) {
				...
				var29.packetBuffer.method8903(this.field746);
				packetWriter.addNode(var29);
				packetWriter.flush();
				this.field746 = null;
				class347.method6613(6);
			...
			if (loginState == 13) {
				...
				if (loginState != 16) {
					...
					if (var1.available() >= packetWriter.serverPacketLength) {
						...
						var29 = ObjectComposition.getPacketBufferNode(ClientPacket.field3195, packetWriter.isaacCipher);
			...
			if (gameState == 30) {
				while (true) {
					...
					if (!var29) {
						...
						int var15;
						if (timer.field4499) {
							var14 = ObjectComposition.getPacketBufferNode(ClientPacket.field3117, packetWriter.isaacCipher);
							var14.packetBuffer.writeByte(0);
							var15 = var14.packetBuffer.offset;
							timer.write(var14.packetBuffer);
							var14.packetBuffer.method9017(var14.packetBuffer.offset - var15);
						...
						synchronized(class85.mouseRecorder.lock) {
							if (!field522) {
								...
								for (var7 = 0; var7 < class85.mouseRecorder.index && (var30 == null || var30.packetBuffer.offset - var3 < 246); ++var7) {
									...
									if (var9 != field519 || var8 != field520) {
										...
										if (var12 < 8 && var10 >= -32 && var10 <= 31 && var11 >= -32 && var11 <= 31) {
											...
											if (var9 != -1 && var8 != -1) {
												var30.packetBuffer.method9050(var9 | var8 << 16);
											} else {
												var30.packetBuffer.method9050(Integer.MIN_VALUE);
											}
										} else {
								...
								if (var30 != null) {
									var30.packetBuffer.method9017(var30.packetBuffer.offset - var3);
						...
						if (MouseHandler.MouseHandler_lastButton == 1 || !class305.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) {
							...
							var5 = (int)var16;
							var18 = ObjectComposition.getPacketBufferNode(ClientPacket.field3174, packetWriter.isaacCipher);
						...
						if (field739.field2338 > 0) {
							var14 = ObjectComposition.getPacketBufferNode(ClientPacket.field3177, packetWriter.isaacCipher);
							...
							for (var5 = 0; var5 < field739.field2338; ++var5) {
								...
								field744 = var19;
								var14.packetBuffer.method8951(field739.field2339[var5]);
								var14.packetBuffer.method9065((int)var21);
							}
						...
						if (field604 && field637 <= 0) {
							field637 = 20;
							field604 = false;
							var14 = ObjectComposition.getPacketBufferNode(ClientPacket.field3183, packetWriter.isaacCipher);
							var14.packetBuffer.method8949(camAngleX);
							var14.packetBuffer.method8948(camAngleY);
							packetWriter.addNode(var14);
						}

						if (class31.hasFocus && !hadFocus) {
							hadFocus = true;
							var14 = ObjectComposition.getPacketBufferNode(ClientPacket.field3158, packetWriter.isaacCipher);
						...
						for (var1 = 0; var1 < soundEffectCount; ++var1) {
							...
							if (queuedSoundEffectDelays[var1] >= -10) {
								...
								if (queuedSoundEffectDelays[var1] < 0) {
									...
									if (var3 > 0) {
										RawSound var24 = var32.toRawSound().resample(FloorOverlayDefinition.field2259);
						...
						if (RouteStrategy.method4214() && field739.method4134(82) && field739.method4134(81) && mouseWheelRotation != 0) {
							...
							if (var3 != Projectile.localPlayer.plane) {
								...
								var18.packetBuffer.method9000(var5);
								var18.packetBuffer.writeByte(var3);
								var18.packetBuffer.method8949(var4);
								var18.packetBuffer.method8961(0);
								packetWriter.addNode(var18);
							}
																			...
																			do {
																				...
																				if (var51 == null) {
																					...
																					if (Scene.shouldSendWalk()) {
																						...
																						PacketBufferNode var48 = ObjectComposition.getPacketBufferNode(ClientPacket.field3134, packetWriter.isaacCipher);
																						var48.packetBuffer.writeByte(5);
																						var48.packetBuffer.method8951(field739.method4134(82) ? (field739.method4134(81) ? 2 : 1) : 0);
																						var48.packetBuffer.writeShort(class213.baseX * 64 + var3);
																						var48.packetBuffer.method8949(class101.baseY * 64 + var4);
																					...
																					if (field691) {
																						...
																						if (!field725) {
																							var3 = HealthBarUpdate.field1233 * 16384 + 64;
																					...
																					if (var3 > 15000 && var4 > 15000) {
																						...
																						var18 = ObjectComposition.getPacketBufferNode(ClientPacket.field3178, packetWriter.isaacCipher);
																						packetWriter.addNode(var18);
																					}
																					...
																					if (packetWriter.pendingWrites > 50) {
																						var18 = ObjectComposition.getPacketBufferNode(ClientPacket.field3149, packetWriter.isaacCipher);
																						packetWriter.addNode(var18);
																					}
																			...
																			case 1:
																				...
																				if (var35) {
																					...
																					if (var40 != null) {
																						...
																						var26.packetBuffer.method8962(var40[2]);
																						var26.packetBuffer.method8962(var40[0]);
																						var26.packetBuffer.method8961(var40[1]);
																						var26.packetBuffer.method9050(var51.field2332.method6374());
					...
					var30 = ObjectComposition.getPacketBufferNode(ClientPacket.field3166, packetWriter.isaacCipher);
					var30.packetBuffer.writeByte(0);
					var3 = var30.packetBuffer.offset;
	...
	public void vmethod5914(int var1, int var2) {
		if (var1 > -1 && class10.clientPreferences.method2488() > 0 && !playingJingle) {
			...
			var3.packetBuffer.method9050(var1);
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) {
			if (mouseCrossColor == 1) {
				class12.crossSprites[mouseCrossState * 400 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}

			if (mouseCrossColor == 2) {
				class12.crossSprites[mouseCrossState * 400 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}
		}
				...
				if (var6 - 64 <= var14.field843 && class10.clientPreferences.method2450() != 0 && var1 == var14.plane) {
					...
					if (var14.stream1 == null) {
						if (var14.soundEffectId >= 0) {
							...
							if (var8 != null) {
								RawSound var9 = var8.toRawSound().resample(FloorOverlayDefinition.field2259);
					...
					if (var14.stream2 == null) {
						if (var14.soundEffectIds != null && (var14.field848 -= var12) <= 0) {
							...
							if (var15 != null) {
								RawSound var16 = var15.toRawSound().resample(FloorOverlayDefinition.field2259);
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3220 == var1.serverPacket) {
					...
					if (!var59 && field626 == 0) {
						field737[field777] = var10;
						field777 = (field777 + 1) % 100;
				...
				if (ServerPacket.field3238 == var1.serverPacket) {
					var64 = var3.method9030();
					if (var64 == 65535) {
						var64 = -1;
					}

					var5 = var3.readInt();
					var25 = var3.method8963();
				...
				if (ServerPacket.field3240 == var1.serverPacket) {
					for (var64 = 0; var64 < Varps.Varps_main.length; ++var64) {
						if (Varps.Varps_temp[var64] != Varps.Varps_main[var64]) {
							...
							changedVarps[++changedVarpCount - 1 & 31] = var64;
						}
					}
				...
				if (ServerPacket.field3321 == var1.serverPacket) {
					...
					for (var8 = 0; var8 < var74; ++var8) {
						var29 = var3.method8943();
						if (var29 == 255) {
							var29 = var3.readInt();
						}

						var76 = var3.method8952();
						if (var53 != null && var8 < var53.itemIds.length) {
							var53.itemIds[var8] = var76;
							var53.field3655[var8] = var29;
						}
				...
				if (ServerPacket.field3250 == var1.serverPacket) {
					var5 = var3.method8950();
					var64 = var3.method8950();
					var25 = var3.method8943();
					if (var5 == 65535) {
						var5 = -1;
					}
					...
					if (var84 != null) {
						...
						} else if (var5 == -1 || var84.sequence == -1 || WorldMapLabelSize.SequenceDefinition_get(var5).field2278 >= WorldMapLabelSize.SequenceDefinition_get(var84.sequence).field2278) {
							var84.sequence = var5;
							var84.sequenceFrame = 0;
							var84.sequenceFrameCycle = 0;
							var84.sequenceDelay = var25;
							var84.field1200 = 0;
							var84.field1226 = var84.pathLength;
						}
					}
				...
				if (ServerPacket.field3236 == var1.serverPacket) {
					...
					HealthBarUpdate.method2400(var64, var5);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3271 == var1.serverPacket) {
					...
					var76 = var29 >> 2;
					var32 = var29 & 3;
					var12 = field570[var76];
					var61 = var3.method8950();
					...
					if (var74 >= 0 && var8 >= 0 && var74 < 103 && var8 < 103) {
						if (var12 == 0) {
							BoundaryObject var88 = class36.scene.method4534(Clock.Client_plane, var74, var8);
							if (var88 != null) {
							...
							WallDecoration var86 = class36.scene.method4535(Clock.Client_plane, var74, var8);
							if (var86 != null) {
				...
				if (ServerPacket.field3258 == var1.serverPacket) {
					var64 = var3.method8918();
					var5 = var3.readUnsignedShort();
					if (var5 == 65535) {
						var5 = -1;
					}

					var25 = var3.method8918();
				...
				if (ServerPacket.field3228 == var1.serverPacket) {
					...
					for (; var25-- > 0; var91.field1057 = true) {
						var74 = var3.readInt();
						var8 = var3.readUnsignedShort();
						var29 = var3.readUnsignedByte();
				...
				if (ServerPacket.field3335 == var1.serverPacket) {
					...
					var27 = (var22 << 32) + var7;
					var79 = false;
					ClanChannel var95 = var20 >= 0 ? currentClanChannels[var20] : VerticalAlignment.guestClanChannel;
					if (var95 == null) {
						var79 = true;
					} else {
						for (var61 = 0; var61 < 100; ++var61) {
							if (var27 == field737[var61]) {
								var79 = true;
								break;
							}
						}
				...
				if (ServerPacket.field3323 == var1.serverPacket) {
					...
					PacketBufferNode var80 = ObjectComposition.getPacketBufferNode(ClientPacket.field3123, packetWriter.isaacCipher);
					var80.packetBuffer.method8940(GameEngine.fps);
					var80.packetBuffer.method8940(var25);
					var80.packetBuffer.method8961(var64);
					var80.packetBuffer.method8919(var5);
				...
				if (ServerPacket.field3229 == var1.serverPacket) {
					var64 = var3.method8952();
					var5 = var3.method8941();
					short var81 = (short)var3.method8953();
					var74 = var3.readInt();
					var89 = npcs[var64];
					if (var89 != null) {
						var89.method2565(var5, var74, var81);
					}
				...
				if (ServerPacket.field3317 == var1.serverPacket) {
					WorldMapIcon_0.field2950 = var3.method8943();
					Archive.field4231 = var3.method8942();
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3224 == var1.serverPacket) {
					rebootTimer = var3.method9030() * 30;
					field711 = cycleCntr;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3300 == var1.serverPacket) {
					Archive.field4231 = var3.method8943();
					WorldMapIcon_0.field2950 = var3.method8941();

					while (var3.offset < var1.serverPacketLength) {
						var64 = var3.readUnsignedByte();
						class294 var72 = class135.method3046()[var64];
				...
				if (ServerPacket.field3328 == var1.serverPacket) {
					...
					field540 = new class465(class208.cameraX, ByteArrayPool.cameraZ, var29, var74, var8, var76, var5, var25);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3270 == var1.serverPacket) {
					...
					if (var92 != null) {
						Messages.invalidateWidget(var92);
						Projectile.revalidateWidgetScroll(class16.Widget_interfaceComponents[var92.id >>> 16], var92, true);
					}
				...
				if (ServerPacket.field3303 == var1.serverPacket) {
					...
					field691 = false;
					field725 = false;
					HealthBarUpdate.field1233 = var3.readUnsignedByte() * 128;
					...
					if (class209.field2322 >= 100) {
						var64 = HealthBarUpdate.field1233 * 16384 + 64;
						var5 = class137.field1605 * 16384 + 64;
						var25 = Renderable.getTileHeight(var64, var5, Clock.Client_plane) - HitSplatDefinition.field2142;
				...
				if (ServerPacket.field3333 == var1.serverPacket) {
					...
					for (var64 = WorldMapIcon_0.field2950; var64 < WorldMapIcon_0.field2950 + 8; ++var64) {
				...
				if (ServerPacket.field3297 == var1.serverPacket) {
					...
					field691 = false;
					field725 = true;
					var64 = GrandExchangeOfferTotalQuantityComparator.method6812(var3.readShort() & 2027);
					...
					field768 = new class466(class291.cameraYaw, var64, var25, var74);
					var1.serverPacket = null;
					return true;
				}

				if (ServerPacket.field3246 == var1.serverPacket) {
					var20 = var3.method8971();
					var5 = var3.method8952();
				...
				if (ServerPacket.field3315 == var1.serverPacket) {
					...
					field771[var64] = true;
					field772[var64] = var5;
					field695[var64] = var25;
					field774[var64] = var74;
					field763[var64] = 0;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3232 == var1.serverPacket) {
					var29 = var3.readUnsignedShort();
					var32 = var3.method8952();
					var25 = var3.method9106();
					var64 = var25 >> 16;
					var5 = var25 >> 8 & 255;
					var74 = var64 + (var25 >> 4 & 7);
					var8 = var5 + (var25 & 7);
					var76 = var3.method8943();
				...
				if (ServerPacket.field3299 == var1.serverPacket) {
					...
					var64 = var3.readUnsignedShort();
					var5 = var3.readUnsignedByte();
					var25 = HealthBarUpdate.field1233 * 16384 + 64;
					...
					var62 = class322.method5990((int)(Math.atan2((double)var76, var93) * 325.9490051269531D) & 2047);
					var15 = GrandExchangeOfferTotalQuantityComparator.method6812((int)(Math.atan2((double)var29, (double)var32) * -325.9490051269531D) & 2047);
					field769 = new class466(MusicPatchNode.cameraPitch, var62, var64, var5);
					field768 = new class466(class291.cameraYaw, var15, var64, var5);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3230 == var1.serverPacket) {
					...
					var76 = class217.field2401 * 128 + 64;
					var79 = false;
					var59 = false;
					if (field581) {
					...
					field540 = new class464(class208.cameraX, ByteArrayPool.cameraZ, var32, var29, var76, var12, var5, var25, var74, var8);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3253 == var1.serverPacket) {
					PlatformInfo.method8310();
					var64 = var3.method8941();
					var5 = var3.method8963();
					var25 = var3.method8942();
					...
					changedSkills[++changedSkillsCount - 1 & 31] = var64;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3241 == var1.serverPacket) {
					var64 = var3.readUnsignedByte();
					WorldMapSection0.method5416(var64);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3262 == var1.serverPacket) {
					...
					var12 = var3.method9030();
					var15 = var3.method8952();
					int var17 = var3.method8943();
					byte var75 = var3.method8979();
					var25 = var3.method8957();
					var64 = var25 >> 16;
					var5 = var25 >> 8 & 255;
					var74 = var64 + (var25 >> 4 & 7);
					var8 = var5 + (var25 & 7);
					byte var30 = var3.method8971();
					var32 = var3.method9027();
					var16 = var3.method8952();
					var61 = var3.method8943() * 4;
					var62 = var3.method8941() * 4;
					var29 = var75 + var74;
					var76 = var30 + var8;
				...
				if (ServerPacket.field3257 == var1.serverPacket) {
					var74 = var3.method8943();
					var5 = var3.readInt();
					var64 = var3.method9030();
					var89 = npcs[var64];
					var25 = var3.method8952();
					if (var89 != null) {
						var89.updateSpotAnimation(var74, var25, var5 >> 16, var5 & 65535);
					}
				...
				if (ServerPacket.field3322 == var1.serverPacket) {
					var64 = var3.method8950();
					ParamComposition.method3838(var64);
					changedItemContainers[++field701 - 1 & 31] = var64 & 32767;
					var1.serverPacket = null;
					return true;
				}

				if (ServerPacket.field3336 == var1.serverPacket) {
					for (var64 = 0; var64 < VarpDefinition.field1903; ++var64) {
				...
				if (ServerPacket.field3267 == var1.serverPacket) {
					...
					var5 = var3.method8952();
					if (var87 != null) {
						var87.updateSpotAnimation(var74, var5, var25 >> 16, var25 & 65535);
					}
				...
				if (ServerPacket.field3254 == var1.serverPacket) {
					...
					var5 = var3.method8964();
					var53 = FriendSystem.getWidget(var5);
					MusicPatchPcmStream.method5941(var53, Projectile.localPlayer.appearance.gender, var64);
					Messages.invalidateWidget(var53);
					var1.serverPacket = null;
					return true;
				}
		...
		if (clickedWidget == null) {
			...
			if (isMenuOpen) {
				if (var1 != 1 && (class305.mouseCam || var1 != 4)) {
					...
					if (var2 < class180.menuX - 10 || var2 > class237.field2681 + class180.menuX + 10 || var3 < NewStuff.menuY - 10 || var3 > class60.field444 + NewStuff.menuY + 10) {
						isMenuOpen = false;
						class20.method305(class180.menuX, NewStuff.menuY, class237.field2681, class60.field444);
					}
				}
	...
	final void openMenu(int var1, int var2) {
		...
		class180.menuX = var5;
		NewStuff.menuY = var6;
		class237.field2681 = var3;
		class60.field444 = menuOptionsCount * 15 + 22;
			...
			if (MouseHandler.MouseHandler_currentButton == 0) {
				if (isDraggingWidget) {
					...
					if (draggedOnWidget != null) {
						...
						if (var13 != null) {
							PacketBufferNode var12 = ObjectComposition.getPacketBufferNode(ClientPacket.field3119, packetWriter.isaacCipher);
							var12.packetBuffer.method8948(clickedWidget.itemId);
							var12.packetBuffer.method8948(draggedOnWidget.childIndex);
							var12.packetBuffer.method9050(draggedOnWidget.id);
							var12.packetBuffer.method8961(clickedWidget.id);
							var12.packetBuffer.method8949(clickedWidget.childIndex);
							var12.packetBuffer.method9000(draggedOnWidget.itemId);
