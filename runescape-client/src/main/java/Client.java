...
public final class Client extends GameEngine implements Usernamed, OAuthApi {
	...
	static {
		...
		field693 = new int[]{768, 1024, 1280, 512, 1536, 256, 0, 1792};
	...
	protected final void setUp() {
		...
		FriendsChat.worldPort = gameBuild == 0 ? 43594 : worldId + 40000;
		class127.js5Port = gameBuild == 0 ? 443 : worldId + 50000;
	...
	final void doCycleLoggedOut() {
		...
		try {
			...
			if (loginState == 5) {
				...
				var33.packetBuffer.method9109(DevicePcmPlayerProvider.field117.hash);
				var33.packetBuffer.method9109(GrandExchangeOfferUnitPriceComparator.archive18.hash);
				var33.packetBuffer.method9043(GrandExchangeOfferTotalQuantityComparator.archive9.hash);
				var33.packetBuffer.method9107(class452.archive8.hash);
				var33.packetBuffer.method9043(class126.archive15.hash);
				var33.packetBuffer.method9107(NetFileRequest.archive10.hash);
				var33.packetBuffer.writeInt(class399.archive6.hash);
				var33.packetBuffer.method9107(class85.archive2.hash);
				var33.packetBuffer.method9107(class85.archive4.hash);
				var33.packetBuffer.method9043(class28.archive19.hash);
				var33.packetBuffer.method9107(class230.archive14.hash);
				var33.packetBuffer.method9109(class128.archive13.hash);
				var33.packetBuffer.method9109(WorldMapLabelSize.field2868.hash);
				var33.packetBuffer.method9107(FloorUnderlayDefinition.archive11.hash);
				var33.packetBuffer.method9043(class168.archive17.hash);
				var33.packetBuffer.method9107(class195.field2101.hash);
				var33.packetBuffer.method9107(GameBuild.archive7.hash);
				var33.packetBuffer.method9109(class205.archive20.hash);
				var33.packetBuffer.method9109(0);
				var33.packetBuffer.method9043(class426.field4687.hash);
				var33.packetBuffer.method9109(class126.archive12.hash);
			...
			if (loginState == 9 && this.field553.method58()) {
				...
				var27.packetBuffer.method9050(this.field541);
				packetWriter.addNode(var27);
				packetWriter.flush();
				this.field541 = null;
				class284.method5687(6);
			...
			if (gameState == 30) {
				while (true) {
					...
					if (!var30) {
						...
						int var15;
						if (timer.field4483) {
							var14 = class330.getPacketBufferNode(ClientPacket.field3186, packetWriter.isaacCipher);
							var14.packetBuffer.writeByte(0);
							var15 = var14.packetBuffer.offset;
							timer.write(var14.packetBuffer);
							var14.packetBuffer.method9053(var14.packetBuffer.offset - var15);
						...
						synchronized(UserComparator6.mouseRecorder.lock) {
							if (!field603) {
								...
								if (var31 != null) {
									var31.packetBuffer.method9053(var31.packetBuffer.offset - var3);
						...
						if (MouseHandler.MouseHandler_lastButton == 1 || !class473.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) {
							...
							var5 = (int)var16;
							var18 = class330.getPacketBufferNode(ClientPacket.field3111, packetWriter.isaacCipher);
						...
						if (field721.field2363 > 0) {
							var14 = class330.getPacketBufferNode(ClientPacket.field3103, packetWriter.isaacCipher);
						...
						if (field756 && field618 <= 0) {
							field618 = 20;
							field756 = false;
							var14 = class330.getPacketBufferNode(ClientPacket.field3175, packetWriter.isaacCipher);
						...
						if (AbstractByteArrayCopier.hasFocus && !hadFocus) {
							hadFocus = true;
							var14 = class330.getPacketBufferNode(ClientPacket.field3154, packetWriter.isaacCipher);
						...
						if (var34 && field721.method4229(82) && field721.method4229(81) && mouseWheelRotation != 0) {
							...
							if (var4 != MusicPatchNode.localPlayer.plane) {
								...
								var26.packetBuffer.method9043(0);
								var26.packetBuffer.method9096(var5);
								var26.packetBuffer.method9086(var4);
								var26.packetBuffer.method9257(var6);
															...
															while (true) {
																...
																if (var47 == null) {
																	...
																	if (Scene.shouldSendWalk()) {
																		...
																		var18 = class330.getPacketBufferNode(ClientPacket.field3157, packetWriter.isaacCipher);
																		var18.packetBuffer.writeByte(5);
																		var18.packetBuffer.method9257(GameObject.baseY * 64 + var5);
																		var18.packetBuffer.method9132(WorldMapData_0.baseX * 64 + var4);
																		var18.packetBuffer.method9203(field721.method4229(82) ? (field721.method4229(81) ? 2 : 1) : 0);
																		packetWriter.addNode(var18);
																		Scene.method4562();
																	...
																	if (field731) {
																		...
																		if (!field673) {
																			...
																			var5 = class123.field1499 * 16384 + 64;
																	...
																	if (var4 > 15000 && var5 > 15000) {
																		...
																		var26 = class330.getPacketBufferNode(ClientPacket.field3181, packetWriter.isaacCipher);
																		packetWriter.addNode(var26);
																	}
																	...
																	if (packetWriter.pendingWrites > 50) {
																		var26 = class330.getPacketBufferNode(ClientPacket.field3188, packetWriter.isaacCipher);
																		packetWriter.addNode(var26);
																	}
					...
					var31 = class330.getPacketBufferNode(ClientPacket.field3183, packetWriter.isaacCipher);
					var31.packetBuffer.writeByte(0);
					var3 = var31.packetBuffer.offset;
	...
	final void drawLoggedIn() {
		...
		if (showMouseCross) {
			if (mouseCrossColor == 1) {
				class173.crossSprites[mouseCrossState * 400 / 100].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}

			if (mouseCrossColor == 2) {
				class173.crossSprites[mouseCrossState * 400 / 100 + 4].drawTransBgAt(mouseCrossX - 8, mouseCrossY - 8);
			}
		}
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3246 == var1.serverPacket) {
					...
					var57.packetBuffer.method9086(GameEngine.fps);
					var57.packetBuffer.method9114(var6);
					var57.packetBuffer.method9109(var20);
					var57.packetBuffer.method9109(var5);
				...
				if (ServerPacket.field3218 == var1.serverPacket) {
					var20 = var3.method9111();
					var5 = var3.method9112();
					var6 = var3.method9099();
					if (var6 == 65535) {
						var6 = -1;
					}

					var26 = var3.method9098();
					if (var26 == 65535) {
						var26 = -1;
					}
				...
				if (ServerPacket.field3308 == var1.serverPacket) {
					var20 = var3.method9089();
					var5 = var3.method9090();
					var6 = var3.readInt();
				...
				if (ServerPacket.field3284 == var1.serverPacket) {
					var20 = var3.method9099();
					var5 = var3.readUnsignedShort();
					var6 = var3.method9111();
					var54 = class165.getWidget(var6);
				...
				if (ServerPacket.field3318 == var1.serverPacket) {
					var20 = var3.method9110();
					var5 = var3.method9098();
					short var64 = (short)var3.method9219();
					var26 = var3.method9090();
					var71 = npcs[var5];
					if (var71 != null) {
						var71.method2568(var26, var20, var64);
					}
				...
				if (ServerPacket.field3336 == var1.serverPacket) {
					FontName.field4882 = var3.method9090();
					class9.field43 = var3.readUnsignedByte();

					while (var3.offset < var1.serverPacketLength) {
						var20 = var3.readUnsignedByte();
						class287 var88 = Varcs.method2720()[var20];
						EnumComposition.method3751(var88);
					}
				...
				if (ServerPacket.field3230 == var1.serverPacket) {
					...
					for (var6 = var49.length() - 1; var6 >= 0; --var6) {
						if (var49.charAt(var6) == 's') {
							...
							var86[var6 + 1] = new Integer(var3.readInt());
						}
					}
				...
				if (ServerPacket.field3330 == var1.serverPacket) {
					...
					var5 = var3.readInt();
					var29 = class165.getWidget(var5);
					SecureRandomCallable.method2223(var29, MusicPatchNode.localPlayer.appearance, var68);
					class144.invalidateWidget(var29);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3271 == var1.serverPacket) {
					var20 = var3.method9135();
					var5 = var3.method9112();
					var6 = var20 >> 10 & 31;
					var26 = var20 >> 5 & 31;
					var8 = var20 & 31;
					var30 = (var26 << 11) + (var6 << 19) + (var8 << 3);
					Widget var90 = class165.getWidget(var5);
				...
				if (ServerPacket.field3247 == var1.serverPacket) {
					...
					var65 = var3.method9090() * 4;
					int var18 = var3.method9039();
					byte var83 = var3.method9092();
					var13 = var3.method9039() * 4;
					var96 = var3.readUnsignedShort();
					var16 = var3.method9099();
				...
				if (ServerPacket.field3306 == var1.serverPacket) {
					var20 = var3.method9098();
					var6 = var3.method9089();
					var5 = var3.method9098();
					if (var5 == 65535) {
						var5 = -1;
					}
				...
				if (ServerPacket.field3243 == var1.serverPacket) {
					FontName.field4882 = var3.method9039();
					class9.field43 = var3.method9090();
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3314 == var1.serverPacket) {
					...
					if (!var54.isIf3) {
						...
						var72 = HealthBarUpdate.ItemDefinition_get(var6);
						var54.modelType = 4;
						var54.modelId = var6;
						var54.modelAngleX = var72.xan2d;
						var54.modelAngleY = var72.yan2d;
						var54.modelZoom = var72.zoom2d * 100 / var5;
						class144.invalidateWidget(var54);
					} else {
						var54.itemId = var6;
				...
				if (ServerPacket.field3269 == var1.serverPacket) {
					...
					var10 = class123.field1499 * 16384 + 64;
					var58 = false;
					var41 = false;
					if (field748) {
					...
					field667 = new class452(class36.cameraX, class297.cameraZ, var11, var30, var10, var96, var5, var6, var26, var8);
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3252 == var1.serverPacket) {
					...
					if (class138.field1637 >= 100) {
						...
						class297.cameraZ = class123.field1499 * 16384 + 64;
				...
				if (ServerPacket.field3313 == var1.serverPacket) {
					...
					class9.field43 = var3.method9089();
				...
				if (ServerPacket.field3317 == var1.serverPacket) {
					...
					if (var73 != null) {
						var73.remove();
						interfaceParents.put(var73, (long)var5);
					}
				...
				if (ServerPacket.field3231 == var1.serverPacket) {
					ClientPacket.method5688();
					var20 = var3.method9039();
					var5 = var3.method9039();
					var6 = var3.method9110();
				...
				if (ServerPacket.field3283 == var1.serverPacket) {
					...
					var10 = var30 >> 2;
					var11 = var30 & 3;
					var96 = field563[var10];
					var6 = var3.method9084();
					var20 = var6 >> 16;
					var5 = var6 >> 8 & 255;
					var26 = var20 + (var6 >> 4 & 7);
					var8 = var5 + (var6 & 7);
					var13 = var3.method9135();
					if (var26 >= 0 && var8 >= 0 && var26 < 103 && var8 < 103) {
						if (var96 == 0) {
							BoundaryObject var94 = class31.scene.method4544(GameEngine.Client_plane, var26, var8);
							if (var94 != null) {
							...
							WallDecoration var93 = class31.scene.method4545(GameEngine.Client_plane, var26, var8);
							if (var93 != null) {
				...
				if (ServerPacket.field3326 == var1.serverPacket) {
					...
					var65 = class18.method290((int)(Math.atan2((double)var10, var97) * 325.9490051269531D) & 2047);
					var15 = class425.method8242((int)(Math.atan2((double)var30, (double)var11) * -325.9490051269531D) & 2047);
					field737 = new class454(WorldMapSectionType.cameraPitch, var65, var20, var5);
				...
				if (ServerPacket.field3301 == var1.serverPacket) {
					publicChatMode = var3.method9039();
				...
				if (ServerPacket.field3289 == var1.serverPacket) {
					rebootTimer = var3.method9135() * 30;
					field565 = cycleCntr;
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3249 == var1.serverPacket) {
					...
					for (var8 = 0; var8 < var26; ++var8) {
						var30 = var3.method9135();
						var10 = var3.method9039();
						if (var10 == 255) {
			...
			if (MouseHandler.MouseHandler_currentButton == 0) {
				if (isDraggingWidget) {
					...
					if (draggedOnWidget != null) {
						...
						if (var13 != null) {
							PacketBufferNode var12 = class330.getPacketBufferNode(ClientPacket.field3149, packetWriter.isaacCipher);
							var12.packetBuffer.method9096(draggedOnWidget.itemId);
							var12.packetBuffer.method9107(draggedOnWidget.id);
							var12.packetBuffer.method9096(draggedOnWidget.childIndex);
							var12.packetBuffer.method9096(clickedWidget.childIndex);
							var12.packetBuffer.method9109(clickedWidget.id);
