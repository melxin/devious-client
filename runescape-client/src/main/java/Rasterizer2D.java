...
public class Rasterizer2D extends DualNode {
	...
	@ObfuscatedName("ea")
	protected static void method9384(int[] var0, int var1, int var2, float[] var3) {
	...
	public static void Rasterizer2D_drawRectangle(int var0, int var1, int var2, int var3, int var4) {
		method9400(var0, var1, var2, var4);
		method9400(var0, var3 + var1 - 1, var2, var4);
		method9439(var0, var1, var3, var4);
		method9439(var0 + var2 - 1, var1, var3, var4);
	}
	...
	@ObfuscatedName("ec")
	public static void method9400(int var0, int var1, int var2, int var3) {
	...
	@ObfuscatedName("ee")
	public static void method9439(int var0, int var1, int var2, int var3) {
	...
	public static void Rasterizer2D_drawLine(int var0, int var1, int var2, int var3, int var4) {
		...
		if (var3 == 0) {
			if (var2 >= 0) {
				method9400(var0, var1, var2 + 1, var4);
			} else {
				method9400(var0 + var2, var1, -var2 + 1, var4);
			}

		} else if (var2 == 0) {
			if (var3 >= 0) {
				method9439(var0, var1, var3 + 1, var4);
			} else {
				method9439(var0, var3 + var1, -var3 + 1, var4);
			}
	...
	public static void method9447() {
		if (field5062 != null) {
			...
			if (Rasterizer2D_xClipStart == 0 && Rasterizer2D_xClipEnd == Rasterizer2D_width && Rasterizer2D_yClipStart == 0 && Rasterizer2D_yClipEnd == Rasterizer2D_height) {
				var0 = field5062.length;
				var1 = var0 - (var0 & 7);

				for (var2 = 0; var2 < var1; field5062[var2++] = 0.0F) {
					field5062[var2++] = 0.0F;
					field5062[var2++] = 0.0F;
					field5062[var2++] = 0.0F;
					field5062[var2++] = 0.0F;
	...
	public static void method9404() {
		if (field5062 != null) {
			int var0 = field5062.length;

			for (int var1 = 0; var1 < var0; ++var1) {
				if (var1 % Rasterizer2D_width < Rasterizer2D_width / 2 && field5062[var1] > 0.0F) {
					float var3 = field5062[var1];
					float var4 = 75.0F;
					float var5 = 10000.0F;
