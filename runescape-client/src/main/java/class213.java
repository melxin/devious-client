...
public class class213 {
	...
	static {
		field2377 = new class213(5, 8, 8);
		field2376 = new class213(1, 16, 16);
		field2367 = new class213(6, 32, 32);
		field2370 = new class213(0, 48, 48);
		field2371 = new class213(4, 64, 64);
		field2372 = new class213(3, 96, 96);
		field2373 = new class213(2, 128, 128);
		field2368 = class126.method2956();
	...
	static final void method4211(class294 var0) {
		...
		if (class294.field3207 == var0) {
			var2 = var1.method8942();
			var3 = (var2 >> 4 & 7) + WorldMapIcon_0.field2950;
			var4 = (var2 & 7) + Archive.field4231;
			var5 = var1.method8943();
			var6 = var5 >> 4 & 15;
			var7 = var5 & 7;
			var8 = var1.method8950();
			var9 = var1.method8941();
		...
		if (class294.field3201 == var0) {
			var2 = var1.method8952();
			var36 = var1.method8971();
			byte var38 = var1.readByte();
			byte var39 = var1.method8971();
			var6 = var1.method9030();
			var7 = var1.method8943();
			var8 = var7 >> 2;
			var9 = var7 & 3;
			var10 = Client.field570[var8];
			var11 = var1.method8950();
			byte var12 = var1.method9022();
			var13 = var1.method8943();
		...
		if (class294.field3205 == var0) {
			var2 = var1.method8943();
			var3 = var1.readUnsignedByte();
			var4 = var3 >> 2;
			var5 = var3 & 3;
			var6 = Client.field570[var4];
			var7 = var1.method8952();
			...
			if (var4 >= 0 && var5 >= 0 && var4 < 103 && var5 < 103) {
				...
				if (var9 == 1) {
					WallDecoration var43 = class36.scene.method4535(Clock.Client_plane, var4, var5);
					if (var43 != null) {
						var11 = class215.Entity_unpackID(var43.tag);
						if (var7 != 4 && var7 != 5) {
							if (var7 == 6) {
								...
								var43.renderable1 = new DynamicObject(var11, 4, var8 + 4, Clock.Client_plane, var4, var5, var2, false, var43.renderable1);
								var43.renderable2 = new DynamicObject(var11, 4, (var8 + 2 & 3) + 4, Clock.Client_plane, var4, var5, var2, false, var43.renderable2);
							}
						} else {
				...
				if (var9 == 2) {
					GameObject var44 = class36.scene.getGameObject(Clock.Client_plane, var4, var5);
					if (var7 == 11) {
						var7 = 10;
					}

					if (var44 != null) {
						var44.renderable = new DynamicObject(class215.Entity_unpackID(var44.tag), var7, var8, Clock.Client_plane, var4, var5, var2, false, var44.renderable);
						return;
					}
				}

				if (var9 == 3) {
					FloorDecoration var45 = class36.scene.getFloorDecoration(Clock.Client_plane, var4, var5);
					if (var45 != null) {
						var45.renderable = new DynamicObject(class215.Entity_unpackID(var45.tag), 22, var8, Clock.Client_plane, var4, var5, var2, false, var45.renderable);
						return;
					}
				}
			...
			if (class294.field3206 == var0) {
				...
				var3 = var1.method8943();
				var4 = var1.method8941();
				...
				var4 = (var3 >> 4 & 7) + WorldMapIcon_0.field2950;
				var5 = (var3 & 7) + Archive.field4231;
				var6 = var1.method8950();
				if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104) {
					var34 = Client.groundItems[Clock.Client_plane][var4][var5];
					if (var34 != null) {
						for (var41 = (TileItem)var34.last(); var41 != null; var41 = (TileItem)var34.previous()) {
							if ((var6 & 32767) == var41.id && var2 == var41.quantity) {
								var41.remove();
								break;
							}
						}
				...
				var36 = var1.method9022();
				var4 = var1.method8942();
				var5 = var1.readUnsignedByte() * 4;
				var6 = var1.method9030();
				var7 = var1.method8943() * 4;
				var8 = var1.method9030();
				var9 = var1.method8959();
				var10 = var1.method8943();
				var11 = (var10 >> 4 & 7) + WorldMapIcon_0.field2950;
				int var40 = (var10 & 7) + Archive.field4231;
				var13 = var1.method8952();
				var14 = var1.method8943();
				var2 = var37 + var11;
				var3 = var36 + var40;
				if (var11 >= 0 && var40 >= 0 && var11 < 104 && var40 < 104 && var2 >= 0 && var3 >= 0 && var2 < 104 && var3 < 104 && var6 != 65535) {
					var11 = var11 * 128 + 64;
					var40 = var40 * 128 + 64;
					var2 = var2 * 128 + 64;
					var3 = var3 * 128 + 64;
					Projectile var33 = new Projectile(var6, Clock.Client_plane, var11, var40, Renderable.getTileHeight(var11, var40, Clock.Client_plane) - var5, var13 + Client.cycle, var8 + Client.cycle, var14, var4, var9, var7);
				...
				if (class294.field3200 == var0) {
					...
					var3 = (var2 >> 4 & 7) + WorldMapIcon_0.field2950;
					var4 = (var2 & 7) + Archive.field4231;
					var5 = var1.method8950();
					var6 = var1.method8943();
					var7 = var1.readUnsignedShort();
					if (var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
						var3 = var3 * 128 + 64;
						var4 = var4 * 128 + 64;
						GraphicsObject var42 = new GraphicsObject(var7, Clock.Client_plane, var3, var4, Renderable.getTileHeight(var3, var4, Clock.Client_plane) - var6, var5, Client.cycle);
					...
					var4 = (var2 & 7) + Archive.field4231;
					var1.method8942();
					var5 = var1.method8964();
					var1.method8950();
					var6 = var1.method8952();
					var1.method8941();
					var1.method8950();
