		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState == 20) {
				...
				if (Login.loginIndex != 4 && Login.loginIndex != 10) {
					...
					for (var5 = class18.method287(); var0.stringWidth(var5) > var24; var5 = var5.substring(0, var5.length() - 1)) {
					}

					var0.draw(AbstractFont.escapeBrackets(var5), Login.loginBoxX + 180 - 70, var23, 16777215, 0);
					var23 += 15;

					for (var6 = WorldMapDecorationType.method6573(Login.Login_password); var0.stringWidth(var6) > var24; var6 = var6.substring(1)) {
					}
			...
			if (Client.gameState == 10 || Client.gameState == 11 || Client.gameState == 50) {
				...
				if (Login.loginIndex == 0) {
					...
					if (Login.loginIndex == 2) {
						...
						for (var5 = class18.method287(); var0.stringWidth(var5) > var24; var5 = var5.substring(1)) {
						}
						...
						class96.field1295 = new Bounds(class143.loginBoxCenter, var22, var1.stringWidth(class18.field97), 11);
						class19.field103 = new Bounds(class143.loginBoxCenter, var22, var1.stringWidth("Still having trouble logging in?"), 11);
						var1.drawCentered(class18.field97, class143.loginBoxCenter, var22, 16777215, 0);
						...
						if (Login.loginIndex == 4) {
							...
							var0.drawCentered(Login.Login_response3, Login.loginBoxX + 180, var23, 16777215, 0);
							var23 += 15;
							var0.draw("PIN: " + WorldMapDecorationType.method6573(Messages.otp) + (Client.cycle % 40 < 20 ? class383.colorStartTag(16776960) + "|" : ""), Login.loginBoxX + 180 - 108, var23, 16777215, 0);
							var23 -= 8;
							...
							if (WorldMapSectionType.field2983 && !Client.onMobile) {
								...
								for (var27 = 0; var27 < 8; ++var27) {
									class292.titlebuttonSprite.method9492(var4, var23, 30, 40);
									boolean var28 = var27 == Login.field909 & Client.cycle % 40 < 20;
									var0.draw((Login.field910[var27] == null ? "" : Login.field910[var27]) + (var28 ? class383.colorStartTag(16776960) + "|" : ""), var4 + 10, var23 + 27, 16777215, 0);
									if (var27 != 1 && var27 != 3) {
										var4 += 35;
									} else {
										var4 += 50;
							...
							var4 = var24 + 20;
							class439.field4717.drawAt(var23 - 109, var4);
							if (Login.field911.isEmpty()) {
								class376.field4398.drawAt(var23 - 48, var4 + 18);
							} else {
								class376.field4398.drawAt(var23 - 48, var4 + 5);
								var0.drawCentered(Login.field911, var23, var4 + 68 - 15, 16776960, 0);
							}
							...
							var0.drawCentered(var18, Login.loginBoxX + 180, var22, 16776960, 0);
							var23 = var22 + 20;
			...
			if (Client.gameState > 5 && Language.Language_EN == ClanSettings.clientLanguage) {
				if (class319.field3726 != null) {
					...
					byte var31 = 100;
					byte var30 = 35;
					class319.field3726.drawAt(var23, var24);
