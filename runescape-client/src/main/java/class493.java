...
public class class493 implements MouseWheel {
	...
	static {
		field5048 = new class493(5, 0);
		field5044 = new class493(1, 2);
		field5046 = new class493(2, 5);
		field5045 = new class493(4, 6);
		field5047 = new class493(0, 7);
		field5049 = new class493(3, 8);
	}
