...
public class class490 implements class369 {
	...
	static {
		field4973 = new class490(1, 0, Integer.class, new class487());
		field4972 = new class490(2, 1, Long.class, new class489());
		field4976 = new class490(0, 2, String.class, new class491());
	}
