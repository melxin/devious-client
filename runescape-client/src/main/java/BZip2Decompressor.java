...
public final class BZip2Decompressor {
	...
	public static int BZip2Decompressor_decompress(byte[] var0, int var1, byte[] var2, int var3, int var4) {
		synchronized(BZip2Decompressor_state) {
			...
			BZip2Decompressor_state.field5010 = 0;
	...
	static void method9318(BZip2State var0) {
		...
		int var13 = var0.field5010;
		var0.field5010 += var10 - var10;
		if (var0.field5010 < var13) {
		}
	...
	static void BZip2Decompressor_decompress(BZip2State var0) {
		...
		if (class206.BZip2Decompressor_block == null) {
			class206.BZip2Decompressor_block = new int[var0.blockSize100k * 100000];
		}
			...
			while (var26) {
				...
				while (true) {
					...
					for (var36 = 0; var36 < var47; ++var36) {
						...
						var10000 = class206.BZip2Decompressor_block;
						int var10001 = var0.cftab[var1 & 255];
						var10000[var10001] |= var36 << 8;
						var10002 = var0.cftab[var1 & 255]++;
					}

					var0.field5017 = class206.BZip2Decompressor_block[var0.originalPointer] >> 8;
					var0.nblocks_used = 0;
					var0.field5017 = class206.BZip2Decompressor_block[var0.field5017];
					var0.su_ch2 = (byte)(var0.field5017 & 255);
					var0.field5017 >>= 8;
					++var0.nblocks_used;
					var0.field5035 = var47;
					method9318(var0);
					if (var0.field5035 + 1 == var0.nblocks_used && var0.su_rNToGo == 0) {
						var26 = true;
						break;
					}
