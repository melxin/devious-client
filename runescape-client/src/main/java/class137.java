...
public enum class137 implements class369 {
	...
	static final void method3090(PacketBuffer var0, int var1, Player var2, int var3) {
		...
		if ((var3 & 256) != 0) {
			...
			PlayerType var8 = (PlayerType)GameObject.findEnumerated(HealthBarDefinition.PlayerType_values(), var0.method8941());
			boolean var9 = var0.readUnsignedByte() == 1;
			var10 = var0.method8941();
			var11 = var0.offset;
			if (var2.username != null && var2.appearance != null) {
				...
				if (!var12 && Client.field626 == 0 && !var2.isHidden) {
					...
					var0.method9041(Players.field1342.array, 0, var10);
					Players.field1342.offset = 0;
		...
		if ((var3 & 65536) != 0) {
			...
			for (var6 = 0; var6 < var5; ++var6) {
				...
				var19 = var0.method8950();
				var22 = var0.method8918();
				var2.updateSpotAnimation(var7, var19, var22 >> 16, var22 & 65535);
			}
		}
		...
		if ((var3 & 2048) != 0) {
			...
			var16[var1] = (class216)GameObject.findEnumerated(var17, var0.method9022());
		}

		int var24;
		if ((var3 & 64) != 0) {
			var5 = var0.readUnsignedShort();
			PlayerType var18 = (PlayerType)GameObject.findEnumerated(HealthBarDefinition.PlayerType_values(), var0.method8941());
			boolean var21 = var0.method8942() == 1;
			...
			if (var2.username != null && var2.appearance != null) {
				...
				if (!var23 && Client.field626 == 0 && !var2.isHidden) {
					Players.field1342.offset = 0;
					var0.method9041(Players.field1342.array, 0, var19);
					Players.field1342.offset = 0;
		...
		if ((var3 & 1) != 0) {
			...
			if (var6 > 0) {
				for (var7 = 0; var7 < var6; ++var7) {
					...
					if (var22 != 32767) {
						var10 = var0.readUShortSmart();
						var11 = var0.method8943();
						var24 = var22 > 0 ? var0.method8943() : var11;
		...
		if ((var3 & 16) != 0) {
			var2.targetIndex = var0.method8950();
			var2.targetIndex += var0.method8941() << 16;
			var5 = 16777215;
		...
		if ((var3 & 1024) != 0) {
			var2.field1203 = var0.method9022();
			var2.field1205 = var0.method8971();
			var2.field1173 = var0.method9022();
			var2.field1206 = var0.readByte();
			var2.spotAnimation = var0.method9030() + Client.cycle;
			var2.field1208 = var0.readUnsignedShort() + Client.cycle;
			var2.field1209 = var0.method8950();
			if (var2.field1124) {
		...
		if ((var3 & 2) != 0) {
			var2.field1228 = var0.method8952();
		...
		if ((var3 & 32768) != 0) {
			...
			var2.field1215 = var0.method8971();
