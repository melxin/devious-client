...
public class class207 implements class29 {
	...
	public class207() {
		this.field2355 = new char[128];
		this.field2359 = new int[128];
		this.field2349 = new int[128];
		this.field2363 = 0;
		...
		this.field2364 = 0;
		this.field2357 = 0;
		this.field2358 = new boolean[112];
		this.field2351 = new boolean[112];
		this.field2360 = new boolean[112];
	}
