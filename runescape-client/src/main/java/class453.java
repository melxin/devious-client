...
public class class453 {
	...
	static {
		field4735 = new int[2048];
		field4733 = new int[2048];
		double var0 = 0.0030679615757712823D;

		for (int var2 = 0; var2 < 2048; ++var2) {
			field4735[var2] = (int)(65536.0D * Math.sin((double)var2 * var0));
			field4733[var2] = (int)(65536.0D * Math.cos((double)var2 * var0));
		}
