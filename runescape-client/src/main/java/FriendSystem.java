		...
		if (var1 != null) {
			...
			if (var2.hasCleanName()) {
				if (this.canAddIgnore()) {
					...
					PacketBufferNode var3 = class330.getPacketBufferNode(ClientPacket.field3119, Client.packetWriter.isaacCipher);
					var3.packetBuffer.writeByte(DynamicObject.stringCp1252NullTerminatedByteSize(var1));
					var3.packetBuffer.writeStringCp1252NullTerminated(var1);
					Client.packetWriter.addNode(var3);
				}
		...
		if (var1 != null) {
			...
			if (var2.hasCleanName()) {
				if (this.friendsList.removeByUsername(var2)) {
					...
					PacketBufferNode var3 = class330.getPacketBufferNode(ClientPacket.field3194, Client.packetWriter.isaacCipher);
					var3.packetBuffer.writeByte(DynamicObject.stringCp1252NullTerminatedByteSize(var1));
					var3.packetBuffer.writeStringCp1252NullTerminated(var1);
					Client.packetWriter.addNode(var3);
				}
		...
		if (var1 != null) {
			...
			if (var3.hasCleanName()) {
				if (this.ignoreList.removeByUsername(var3)) {
					Client.field689 = Client.cycleCntr;
					if (var2) {
						PacketBufferNode var4 = class330.getPacketBufferNode(ClientPacket.field3112, Client.packetWriter.isaacCipher);
