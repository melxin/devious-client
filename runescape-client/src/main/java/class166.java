...
public class class166 extends class142 {
	...
	static final void method3380(PacketBuffer var0) {
		for (int var1 = 0; var1 < Client.field579; ++var1) {
			...
			if ((var4 & 256) != 0) {
				var3.field1170 = Client.cycle + var0.method8952();
				var3.field1213 = Client.cycle + var0.method8950();
				var3.field1164 = var0.method8971();
				var3.field1215 = var0.method9022();
				var3.field1196 = var0.method8971();
				var3.field1217 = (byte)var0.method8942();
			}

			if ((var4 & 1024) != 0) {
				var3.field1203 = var0.method8979();
				var3.field1205 = var0.method9022();
				var3.field1173 = var0.method9022();
				var3.field1206 = var0.method9022();
				var3.spotAnimation = var0.readUnsignedShort() + Client.cycle;
				var3.field1208 = var0.method8950() + Client.cycle;
			...
			int var8;
			if ((var4 & 1) != 0) {
				var5 = var0.method8950();
				var6 = var0.method9030();
				var3.field1184 = var0.method8943() == 1;
			...
			if ((var4 & 128) != 0) {
				var3.definition = Bounds.getNpcDefinition(var0.method8950());
			...
			int var9;
			if ((var4 & 262144) != 0) {
				var5 = var0.method8943();

				for (var6 = 0; var6 < var5; ++var6) {
					var7 = var0.readUnsignedByte();
					var8 = var0.method8952();
					var9 = var0.readInt();
				...
				if (var6 > 0) {
					for (var7 = 0; var7 < var6; ++var7) {
						...
						if (var9 != 32767) {
							...
							int var12 = var9 > 0 ? var0.method8942() : var11;
			...
			if ((var4 & 64) != 0) {
				var3.targetIndex = var0.method9030();
			...
			short[] var14;
			if ((var4 & 131072) != 0) {
				var5 = var0.method8941();
				var13 = new int[8];
				var14 = new short[8];

				for (var8 = 0; var8 < 8; ++var8) {
					if ((var5 & 1 << var8) != 0) {
						var13[var8] = var0.method8928();
						var14[var8] = (short)var0.method8938();
					} else {
						var13[var8] = -1;
						var14[var8] = -1;
					}
			...
			if ((var4 & 65536) != 0) {
				var5 = var0.method8963();
				var3.turnLeftSequence = (var5 & 1) != 0 ? var0.method8950() : var3.definition.turnLeftSequence;
				var3.turnRightSequence = (var5 & 2) != 0 ? var0.method8950() : var3.definition.turnRightSequence;
				var3.walkSequence = (var5 & 4) != 0 ? var0.method9030() : var3.definition.walkSequence;
				var3.walkBackSequence = (var5 & 8) != 0 ? var0.method8950() : var3.definition.walkBackSequence;
				var3.walkLeftSequence = (var5 & 16) != 0 ? var0.method8950() : var3.definition.walkLeftSequence;
				var3.walkRightSequence = (var5 & 32) != 0 ? var0.readUnsignedShort() : var3.definition.walkRightSequence;
				var3.runSequence = (var5 & 64) != 0 ? var0.method9030() : var3.definition.field2014;
				var3.field1191 = (var5 & 128) != 0 ? var0.method8952() : var3.definition.field2011;
				var3.field1198 = (var5 & 256) != 0 ? var0.method9030() : var3.definition.field2012;
				var3.field1167 = (var5 & 512) != 0 ? var0.method8950() : var3.definition.field2013;
				var3.field1168 = (var5 & 1024) != 0 ? var0.method8952() : var3.definition.field1994;
				var3.field1169 = (var5 & 2048) != 0 ? var0.method8950() : var3.definition.field2015;
				var3.field1183 = (var5 & 4096) != 0 ? var0.readUnsignedShort() : var3.definition.field2016;
				var3.field1171 = (var5 & 8192) != 0 ? var0.method8950() : var3.definition.field2017;
				var3.idleSequence = (var5 & 16384) != 0 ? var0.method9030() : var3.definition.idleSequence;
			}

			if ((var4 & 4) != 0) {
				var5 = var0.method9030();
				if (var5 == 65535) {
					var5 = -1;
				}

				var6 = var0.method8941();
			...
			if ((var4 & 4096) != 0) {
				var3.method2615(var0.method8943());
			}
			...
			if ((var4 & 512) != 0) {
				...
				if ((var5 & 1) == 1) {
					...
					var13 = null;
					if ((var5 & 2) == 2) {
						var7 = var0.method8942();
						var13 = new int[var7];

						for (var8 = 0; var8 < var7; ++var8) {
							var9 = var0.method9030();
					...
					if ((var5 & 4) == 4) {
						...
						for (var9 = 0; var9 < var8; ++var9) {
							var14[var9] = (short)var0.method8950();
						}
					}
					...
					if ((var5 & 8) == 8) {
						...
						for (var10 = 0; var10 < var9; ++var10) {
							var15[var10] = (short)var0.method8950();
						}
					}

					var18 = false;
					if ((var5 & 16) != 0) {
						var18 = var0.method8942() == 1;
					}
			...
			if ((var4 & 8192) != 0) {
				...
				if ((var5 & 1) == 1) {
					...
					if ((var5 & 4) == 4) {
						...
						for (var9 = 0; var9 < var8; ++var9) {
							var14[var9] = (short)var0.method8952();
						}
					}
					...
					if ((var5 & 8) == 8) {
						...
						for (var10 = 0; var10 < var9; ++var10) {
							var15[var10] = (short)var0.method9030();
						}
					}
