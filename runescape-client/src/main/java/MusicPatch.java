...
public class MusicPatch extends Node {
	...
	MusicPatch(byte[] var1) {
		this.field3466 = new ArrayList(8);
		this.rawSounds = new class53[128];
		this.field3462 = new short[128];
		this.field3463 = new byte[128];
		this.field3468 = new byte[128];
		this.field3465 = new MusicPatchNode2[128];
		this.field3459 = new byte[128];
		...
		if (var42 != null) {
			...
			for (var29 = 2; var29 < var42.length; var29 += 2) {
				...
				for (var33 = var47; var33 < var30; ++var33) {
					var34 = class388.method7213(var32, var30 - var47);
		...
		if (var16 != null) {
			...
			for (var29 = 0; var29 < var47; ++var29) {
				var45 = var44 + (this.field3468[var29] & 255);
				if (var45 < 0) {
					var45 = 0;
				}
				...
				this.field3468[var29] = (byte)var45;
			}
			...
			for (var45 = var47; var45 < 128; ++var45) {
				var46 = var44 + (this.field3468[var45] & 255);
				if (var46 < 0) {
					var46 = 0;
				}
				...
				this.field3468[var45] = (byte)var46;
			}
