		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState == 20) {
				...
				if (Login.loginIndex != 4 && Login.loginIndex != 10) {
					...
					for (var5 = UserComparator10.method2879(); var0.stringWidth(var5) > var27; var5 = var5.substring(0, var5.length() - 1)) {
					}
			...
			if (Client.gameState == 10 || Client.gameState == 11 || Client.gameState == 50) {
				...
				if (Login.loginIndex == 0) {
					...
					if (Login.loginIndex == 2) {
						...
						for (var5 = UserComparator10.method2879(); var0.stringWidth(var5) > var27; var5 = var5.substring(1)) {
						}
						...
						FriendsList.field4572 = new Bounds(class485.loginBoxCenter, var25, var1.stringWidth(WorldMapDecorationType.field3787), 11);
						Calendar.field3770 = new Bounds(class485.loginBoxCenter, var25, var1.stringWidth("Still having trouble logging in?"), 11);
						var1.drawCentered(WorldMapDecorationType.field3787, class485.loginBoxCenter, var25, 16777215, 0);
						...
						if (class112.field1401 && !Client.onMobile) {
							...
							for (var30 = 0; var30 < 8; ++var30) {
								Login.titlebuttonSprite.method9367(var4, var26, 30, 40);
								boolean var33 = var30 == Login.field935 & Client.cycle % 40 < 20;
								var0.draw((Login.field938[var30] == null ? "" : Login.field938[var30]) + (var33 ? Strings.colorStartTag(16776960) + "|" : ""), var4 + 10, var26 + 27, 16777215, 0);
								if (var30 != 1 && var30 != 3) {
									var4 += 35;
								} else {
									var4 += 50;
						...
						var4 = var27 + 20;
						ParamComposition.field2110.drawAt(var26 - 109, var4);
						if (Login.field939.isEmpty()) {
							UserComparator8.field1416.drawAt(var26 - 48, var4 + 18);
						} else {
							UserComparator8.field1416.drawAt(var26 - 48, var4 + 5);
							var0.drawCentered(Login.field939, var26, var4 + 68 - 15, 16776960, 0);
						}
			...
			if (Client.gameState > 5 && Language.Language_EN == TriBool.clientLanguage) {
				if (class19.field97 != null) {
					...
					byte var35 = 100;
					byte var36 = 35;
					class19.field97.drawAt(var26, var27);
		...
		if (var5 != null) {
			...
			if (var8) {
				if (class60.method1131(StudioGame.getWidgetFlags(var5), var0 - 1)) {
					...
					if (var0 == 1) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.field3190, Client.packetWriter.isaacCipher);
					...
					if (var0 == 2) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.field3116, Client.packetWriter.isaacCipher);
						var7.packetBuffer.method9050(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 3) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.field3112, Client.packetWriter.isaacCipher);
						var7.packetBuffer.method9050(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 4) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.field3127, Client.packetWriter.isaacCipher);
						var7.packetBuffer.method9050(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 5) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.field3122, Client.packetWriter.isaacCipher);
						var7.packetBuffer.method9050(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 6) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.field3099, Client.packetWriter.isaacCipher);
						var7.packetBuffer.method9050(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 7) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.field3143, Client.packetWriter.isaacCipher);
						var7.packetBuffer.method9050(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 8) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.field3101, Client.packetWriter.isaacCipher);
						var7.packetBuffer.method9050(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 9) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.field3129, Client.packetWriter.isaacCipher);
						var7.packetBuffer.method9050(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 10) {
						var7 = ObjectComposition.getPacketBufferNode(ClientPacket.field3136, Client.packetWriter.isaacCipher);
						var7.packetBuffer.method9050(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
