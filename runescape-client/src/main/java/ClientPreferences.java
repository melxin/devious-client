...
public class ClientPreferences {
	...
	static final void method2501(PacketBuffer var0, int var1, Player var2, int var3) {
		...
		int var13;
		if ((var3 & 16) != 0) {
			var5 = var0.method9098();
			if (var5 == 65535) {
				var5 = -1;
			}

			var13 = var0.method9090();
			FloorDecoration.performPlayerAnimation(var2, var5, var13);
		}

		if ((var3 & 4) != 0) {
			var2.targetIndex = var0.method9099();
			var2.targetIndex += var0.method9089() << 16;
			var5 = 16777215;
		...
		if ((var3 & 64) != 0) {
			...
			if (var13 > 0) {
				for (var14 = 0; var14 < var13; ++var14) {
					...
					if (var9 != 32767) {
						var10 = var0.readUShortSmart();
						var16 = var0.method9039();
						var12 = var9 > 0 ? var0.method9090() : var16;
		...
		if ((var3 & 32) != 0) {
			...
			boolean var22 = var0.method9090() == 1;
			var8 = var0.method9089();
			var9 = var0.offset;
		...
		if ((var3 & 1024) != 0) {
			...
			var2.spotAnimation = var0.method9099() + Client.cycle;
		...
		if ((var3 & 512) != 0) {
			...
			var15[var1] = (class210)StructComposition.findEnumerated(var19, var0.method9186());
		}
		...
		if ((var3 & 32768) != 0) {
			var2.field1168 = Client.cycle + var0.method9099();
			var2.field1156 = Client.cycle + var0.readUnsignedShort();
			var2.field1180 = var0.readByte();
			var2.field1199 = var0.readByte();
			var2.field1200 = var0.method9186();
			var2.field1208 = (byte)var0.method9090();
		}

		if ((var3 & 65536) != 0) {
			var5 = var0.method9039();
