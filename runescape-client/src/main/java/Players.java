...
public class Players {
	...
	static {
		...
		field1328 = new class216[2048];
		field1332 = new Buffer[2048];
		Players_count = 0;
		...
		field1342 = new Buffer(new byte[5000]);
	}
	...
	static int method2699(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.CHAT_GETFILTER_PUBLIC) {
			...
			PacketBufferNode var13 = ObjectComposition.getPacketBufferNode(ClientPacket.field3125, Client.packetWriter.isaacCipher);
			...
			if (var0 == ScriptOpcodes.CHAT_SENDABUSEREPORT) {
				...
				var6 = ObjectComposition.getPacketBufferNode(ClientPacket.field3139, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYTYPEANDLINE) {
					...
					if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYUID) {
						...
						if (var0 == ScriptOpcodes.CHAT_SENDPUBLIC) {
							...
							var12 = ObjectComposition.getPacketBufferNode(ClientPacket.field3163, Client.packetWriter.isaacCipher);
