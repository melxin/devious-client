...
public class UserComparator6 extends AbstractUserComparator {
	...
	static int method2963(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.CHAT_GETFILTER_PUBLIC) {
			...
			PacketBufferNode var13 = class330.getPacketBufferNode(ClientPacket.field3136, Client.packetWriter.isaacCipher);
			...
			if (var0 == ScriptOpcodes.CHAT_SENDABUSEREPORT) {
				...
				var6 = class330.getPacketBufferNode(ClientPacket.field3171, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYTYPEANDLINE) {
					...
					if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYUID) {
						...
						if (var0 == ScriptOpcodes.CHAT_SENDPUBLIC) {
							...
							var12 = class330.getPacketBufferNode(ClientPacket.field3156, Client.packetWriter.isaacCipher);
