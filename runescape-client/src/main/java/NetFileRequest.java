	...
	static int method6685(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) {
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				PacketBufferNode var13 = class330.getPacketBufferNode(ClientPacket.field3109, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					var7 = Interpreter.Interpreter_stringStack[--SecureRandomCallable.Interpreter_stringStackSize];
					var11 = class330.getPacketBufferNode(ClientPacket.field3163, Client.packetWriter.isaacCipher);
					...
					var7 = Interpreter.Interpreter_stringStack[--SecureRandomCallable.Interpreter_stringStackSize];
					var11 = class330.getPacketBufferNode(ClientPacket.field3152, Client.packetWriter.isaacCipher);
					var11.packetBuffer.writeByte(var7.length() + 1);
					var11.packetBuffer.writeStringCp1252NullTerminated(var7);
					Client.packetWriter.addNode(var11);
					return 1;
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
						var11 = class330.getPacketBufferNode(ClientPacket.field3159, Client.packetWriter.isaacCipher);
						...
						if (var4.length() > 500) {
							...
							var6.packetBuffer.method9203(var3);
