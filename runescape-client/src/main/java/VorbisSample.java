...
public class VorbisSample extends Node {
	...
	float[] method1056(int var1) {
		...
		var2.method1117();
		int var3 = var2.method1118(Tile.iLog(field388.length - 1));
		...
		for (var20 = 0; var20 < var15.field356; ++var20) {
			class46 var45 = field385[var15.field359[var20]];
	...
	static void method1055(byte[] var0) {
		...
		field386 = 1 << var1.method1118(4);
		field394 = 1 << var1.method1118(4);
		...
		var4 = var1.method1118(6) + 1;
		field385 = new class46[var4];

		for (var5 = 0; var5 < var4; ++var5) {
			field385[var5] = new class46();
		}

		var5 = var1.method1118(6) + 1;
		...
		for (int var7 = 0; var7 < var6; ++var7) {
			...
			var1.method1118(16);
			var1.method1118(16);
			field388[var7] = var1.method1118(8);
		}
