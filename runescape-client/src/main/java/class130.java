...
public class class130 implements class369 {
	...
	static {
		field1534 = new class130(0, 0, (String)null, 0);
		field1529 = new class130(1, 1, (String)null, 9);
		field1530 = new class130(2, 2, (String)null, 3);
		field1531 = new class130(3, 3, (String)null, 6);
		field1532 = new class130(4, 4, (String)null, 1);
		field1533 = new class130(5, 5, (String)null, 3);
	}
		...
		if (var0 != null && var0.method2981() != 0) {
			if (var1 < (float)var0.field1510[0].field1457) {
				...
				if (var2 == null) {
					...
					float var6;
					float var7;
					if (0.0D == (double)var2.field1458 && (double)var2.field1459 == 0.0D) {
						var3 = true;
