...
public class EnumComposition extends DualNode {
						...
						if (Login.loginIndex == 1) {
							...
							if (Login.loginIndex == 2) {
								...
								if (class96.field1295 != null) {
									var64 = class96.field1295.highX / 2;
									if (var33 == 1 && var60 >= class96.field1295.lowX - var64 && var60 <= var64 + class96.field1295.lowX && var61 >= var62 - 15 && var61 < var62) {
								...
								var63 = 277;
								Login.field890 = var60 >= var64 && var60 < var64 + ChatChannel.field992 && var61 >= var63 && var61 < var63 + FloorUnderlayDefinition.field2096;
								...
								var63 = 277;
								Login.field902 = var60 >= var64 && var60 < var64 + ChatChannel.field992 && var61 >= var63 && var61 < var63 + FloorUnderlayDefinition.field2096;
								...
								while (true) {
									...
									try {
										...
										while (true) {
											...
											if (!MouseHandler.method714(var17.charAt(var72))) {
												break;
											}
								...
								if (Login.loginIndex == 3) {
									...
									if (var33 == 1 && var37.method8089(var60, var61)) {
									...
									if (Login.loginIndex == 4) {
										...
										if (var33 == 1 && var60 >= var11 - 75 && var60 <= var11 + 75 && var61 >= var12 - 20 && var61 <= var12 + 20) {
											...
											if (Login.Login_username.length() == 0) {
												...
												if (var38 == 0L) {
													...
													var87.encryptRsa(class68.field874, class68.field871);
													var89.writeByte(10);
													...
													class383.method7541(var89);
													var89.writeLong(var40.nextLong());
													var89.encryptRsa(class68.field874, class68.field871);
													...
													String var79 = WorldMapSectionType.method5427(var24.array);

													byte var16;
													try {
														URL var80 = new URL(InvDefinition.method3645("services", false) + "m=accountappeal/login.ws");
														...
														var82.write("data2=" + class397.method7696(var79) + "&dest=" + class397.method7696("passwordchoice.ws"));
														var82.flush();
														...
														while (true) {
															...
															if (var30 == -1) {
																...
																if (var94.startsWith("OFFLINE")) {
																	...
																	if (AttackOption.method2656(var94)) {
										...
										if (class19.field103 != null) {
											...
											if (var33 == 1 && var60 >= class19.field103.lowX - var14 && var60 <= var14 + class19.field103.lowX && var61 >= var63 - 15 && var61 < var63) {
										...
										if (Login.loginIndex == 7) {
												...
												if (var33 == 1 && var60 >= var15 - 75 && var60 <= var15 + 75 && var61 >= var73 - 20 && var61 <= var73 + 20) {
													label1469: {
														...
														if (var86 == null) {
															...
															var19 = class81.method2247(var86);
															var93 = Varcs.method2747();
															...
															if (!var20) {
																...
																if (!var19) {
																	...
																	ByteArrayPool.field4478 = (int)(var86.getTime() / 86400000L - 11745L);
																}
											...
											var11 = Login.loginBoxX + 180;
											var12 = 311;
											if (var34.field2362 == 84 || var34.field2362 == 13 || var33 == 1 && var60 >= var11 - 75 && var60 <= var11 + 75 && var61 >= var12 - 20 && var61 <= var12 + 20) {
												Login.method2100(false);
											}
										} else if (Login.loginIndex == 10) {
											var11 = Login.loginBoxX + 180;
											var12 = 209;
											if (var34.field2362 == 84 || var33 == 1 && var60 >= var11 - 109 && var60 <= var11 + 109 && var61 >= var12 && var61 <= var12 + 68) {
												class205.setLoginResponseString("", "Connecting to server...", "");
											...
											var12 = 233;
											var37 = var2.method7408(0, 30, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var11, var12);
											Bounds var35 = var2.method7408(32, 32, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var11, var12);
											Bounds var36 = var2.method7408(70, 34, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var11, var12);
											var64 = var12 + 17;
											Bounds var52 = var2.method7408(0, 34, "<col=ffd200>agreement (EULA)</col>.", var11, var64);
											if (var33 == 1) {
												if (var37.method8089(var60, var61)) {
													Ignored.openURL("https://www.jagex.com/terms", true, false);
												} else if (var35.method8089(var60, var61)) {
													Ignored.openURL("https://www.jagex.com/terms/privacy", true, false);
												} else if (var36.method8089(var60, var61) || var52.method8089(var60, var61)) {
	...
	static final void method3751(class287 var0) {
		...
		if (class287.field3200 == var0) {
			...
			var37 = (var36 >> 4 & 7) + class9.field43;
			var5 = (var36 & 7) + FontName.field4882;
			var6 = var1.method9039() * 4;
			var7 = var1.method9098();
			var38 = var1.method9039();
			var9 = var1.readUnsignedShort();
			var10 = var1.method9232();
			var11 = var1.method9090() * 4;
			var12 = var1.readUnsignedShort();
			var13 = var1.method9117();
			byte var40 = var1.method9092();
			var14 = var40 + var37;
			var39 = var10 + var5;
			if (var37 >= 0 && var5 >= 0 && var37 < 104 && var5 < 104 && var14 >= 0 && var39 >= 0 && var14 < 104 && var39 < 104 && var7 != 65535) {
				...
				var14 = var14 * 128 + 64;
				var39 = var39 * 128 + 64;
				Projectile var35 = new Projectile(var7, GameEngine.Client_plane, var37, var5, class147.getTileHeight(var37, var5, GameEngine.Client_plane) - var11, var9 + Client.cycle, var12 + Client.cycle, var2, var38, var13, var6);
				var35.setDestination(var14, var39, class147.getTileHeight(var14, var39, GameEngine.Client_plane) - var6, var9 + Client.cycle);
			...
			if (class287.field3197 == var0) {
				...
				byte var3 = var1.method9092();
				byte var4 = var1.method9186();
				var5 = var1.method9089();
				var6 = (var5 >> 4 & 7) + class9.field43;
				var7 = (var5 & 7) + FontName.field4882;
				byte var8 = var1.readByte();
				var9 = var1.readUnsignedShort();
				var10 = var1.method9186();
				var11 = var1.readUnsignedByte();
				var12 = var11 >> 2;
				var13 = var11 & 3;
				var14 = Client.field563[var12];
				int var15 = var1.method9098();
				int var16 = var1.method9099();
				Player var17;
			...
			if (class287.field3196 == var0) {
				var2 = var1.method9039();
				var36 = (var2 >> 4 & 7) + class9.field43;
				var37 = (var2 & 7) + FontName.field4882;
				var5 = var1.readInt();
				var6 = var1.method9099();
				var7 = var1.readInt();
				if (var36 >= 0 && var37 >= 0 && var36 < 104 && var37 < 104) {
					NodeDeque var44 = Client.groundItems[GameEngine.Client_plane][var36][var37];
					if (var44 != null) {
						for (TileItem var34 = (TileItem)var44.last(); var34 != null; var34 = (TileItem)var44.previous()) {
				...
				if (class287.field3205 == var0) {
					var1.method9089();
					var2 = var1.method9110();
					var36 = var1.method9089();
					var37 = var1.readUnsignedByte();
					var5 = (var37 >> 4 & 7) + class9.field43;
					var6 = (var37 & 7) + FontName.field4882;
					var7 = var1.method9098();
					var1.method9135();
					var1.method9098();
					var1.method9090();
					...
					var2 = var1.readUnsignedByte();
					var36 = var1.method9039();
					var37 = (var36 >> 4 & 7) + class9.field43;
					var5 = (var36 & 7) + FontName.field4882;
					var6 = var1.method9090();
					var7 = var6 >> 2;
					var38 = var6 & 3;
					var9 = Client.field563[var7];
					var39 = var1.method9135();
					if (var37 >= 0 && var5 >= 0 && var37 < 104 && var5 < 104) {
						class33.method508(GameEngine.Client_plane, var37, var5, var9, var39, var7, var38, var2, 0, -1);
					}

				} else {
					NodeDeque var33;
					if (class287.field3204 == var0) {
						var2 = var1.method9090();
						var36 = (var2 >> 4 & 7) + class9.field43;
						var37 = (var2 & 7) + FontName.field4882;
						var5 = var1.method9135();
						var6 = var1.method9111();
						if (var36 >= 0 && var37 >= 0 && var36 < 104 && var37 < 104) {
							var33 = Client.groundItems[GameEngine.Client_plane][var36][var37];
							if (var33 != null) {
						...
						if (class287.field3208 == var0) {
							var2 = var1.method9099();
							var36 = var1.method9090();
							var37 = var36 >> 4 & 15;
							var5 = var36 & 7;
							var6 = var1.method9089();
							var7 = (var6 >> 4 & 7) + class9.field43;
							var38 = (var6 & 7) + FontName.field4882;
							var9 = var1.method9039();
							if (var7 >= 0 && var38 >= 0 && var7 < 104 && var38 < 104) {
								var39 = var37 + 1;
								if (MusicPatchNode.localPlayer.pathX[0] >= var7 - var39 && MusicPatchNode.localPlayer.pathX[0] <= var39 + var7 && MusicPatchNode.localPlayer.pathY[0] >= var38 - var39 && MusicPatchNode.localPlayer.pathY[0] <= var38 + var39 && class20.clientPreferences.method2465() != 0 && var5 > 0 && Client.soundEffectCount < 50) {
						...
						if (class287.field3203 == var0) {
							...
							var6 = var1.method9089();
							if (var37 >= 0 && var5 >= 0 && var37 < 104 && var5 < 104) {
								var33 = Client.groundItems[GameEngine.Client_plane][var37][var5];
								if (var33 != null) {
									for (var41 = (TileItem)var33.last(); var41 != null; var41 = (TileItem)var33.previous()) {
										if ((var2 & 32767) == var41.id) {
											var41.method2663(var6);
											break;
										}
									}
								}
							...
							if (class287.field3206 == var0) {
								var2 = var1.method9089();
								var36 = (var2 >> 4 & 7) + class9.field43;
								var37 = (var2 & 7) + FontName.field4882;
								var5 = var1.readUnsignedByte();
								var6 = var5 >> 2;
								var7 = var5 & 3;
								var38 = Client.field563[var6];
								if (var36 >= 0 && var37 >= 0 && var36 < 104 && var37 < 104) {
									class33.method508(GameEngine.Client_plane, var36, var37, var38, -1, var6, var7, 31, 0, -1);
								}

							} else if (class287.field3201 == var0) {
								var2 = var1.method9090();
								var36 = var1.readUnsignedShort();
								var37 = var1.method9039();
								var5 = (var37 >> 4 & 7) + class9.field43;
								var6 = (var37 & 7) + FontName.field4882;
								var7 = var1.method9135();
								if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
									var5 = var5 * 128 + 64;
									var6 = var6 * 128 + 64;
									GraphicsObject var31 = new GraphicsObject(var7, GameEngine.Client_plane, var5, var6, class147.getTileHeight(var5, var6, GameEngine.Client_plane) - var2, var36, Client.cycle);
							...
							if (var36 >= 0 && var37 >= 0 && var36 < 103 && var37 < 103) {
								if (var9 == 0) {
									BoundaryObject var32 = class31.scene.method4544(GameEngine.Client_plane, var36, var37);
									if (var32 != null) {
										var11 = InterfaceParent.Entity_unpackID(var32.tag);
										if (var7 == 2) {
											var32.renderable1 = new DynamicObject(var11, 2, var38 + 4, GameEngine.Client_plane, var36, var37, var5, false, var32.renderable1);
											var32.renderable2 = new DynamicObject(var11, 2, var38 + 1 & 3, GameEngine.Client_plane, var36, var37, var5, false, var32.renderable2);
										} else {
											var32.renderable1 = new DynamicObject(var11, var7, var38, GameEngine.Client_plane, var36, var37, var5, false, var32.renderable1);
										}
								...
								if (var9 == 1) {
									WallDecoration var42 = class31.scene.method4545(GameEngine.Client_plane, var36, var37);
									if (var42 != null) {
										...
										if (var7 != 4 && var7 != 5) {
											if (var7 == 6) {
												...
												var42.renderable1 = new DynamicObject(var11, 4, var38 + 4, GameEngine.Client_plane, var36, var37, var5, false, var42.renderable1);
												var42.renderable2 = new DynamicObject(var11, 4, (var38 + 2 & 3) + 4, GameEngine.Client_plane, var36, var37, var5, false, var42.renderable2);
											}
										} else {
								...
								if (var9 == 2) {
									GameObject var43 = class31.scene.getGameObject(GameEngine.Client_plane, var36, var37);
									if (var7 == 11) {
										var7 = 10;
									}

									if (var43 != null) {
										var43.renderable = new DynamicObject(InterfaceParent.Entity_unpackID(var43.tag), var7, var38, GameEngine.Client_plane, var36, var37, var5, false, var43.renderable);
										return;
									}
								}
								...
								class186.method3736(GameEngine.Client_plane, var36, var37, var9, var5);
							}
