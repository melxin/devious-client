...
public class WorldMapRegion {
				...
				for (int var7 = 0; var7 < var6.length; ++var7) {
					...
					if (class133.method3039(var8.decoration)) {
						...
						if (var8.decoration == WorldMapDecorationType.field3786.id) {
							...
							if (var8.rotation == 1) {
								Rasterizer2D.method9262(this.pixelsPerTile + this.pixelsPerTile * var1 - 1, this.pixelsPerTile * (63 - var2), 1, var10);
							}
						...
						if (var8.decoration == WorldMapDecorationType.field3799.id) {
							...
							if (var11 == 0) {
								for (var12 = 0; var12 < this.pixelsPerTile; ++var12) {
									Rasterizer2D.method9262(var12 + this.pixelsPerTile * var1, (64 - var2) * this.pixelsPerTile - 1 - var12, 1, var10);
								}
							} else {
								for (var12 = 0; var12 < this.pixelsPerTile; ++var12) {
									Rasterizer2D.method9262(var12 + this.pixelsPerTile * var1, var12 + this.pixelsPerTile * (63 - var2), 1, var10);
								}
							}
						}
					}
	...
	void method5206(int var1, int var2, int var3, int var4) {
		...
		if (var3 == 3) {
			Rasterizer2D.method9262(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2) + this.pixelsPerTile - 1, this.pixelsPerTile, var4);
		}
	...
	static int method5289(int var0) {
		return (int)((Math.log((double)var0) / Interpreter.field868 - 7.0D) * 256.0D);
	}
