...
public class class478 implements MouseWheel {
	...
	static {
		field4948 = new class478(1, 0, Integer.class, new class475());
		field4947 = new class478(0, 1, Long.class, new class477());
		field4946 = new class478(2, 2, String.class, new class479());
	}
	...
	static final void clanKickUser(String var0) {
		if (UserComparator5.friendsChat != null) {
			PacketBufferNode var1 = class330.getPacketBufferNode(ClientPacket.field3184, Client.packetWriter.isaacCipher);
