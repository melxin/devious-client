		...
		if (Login.worldSelectOpen) {
			...
			if (Client.gameState != 5) {
				...
				if (Client.gameState == 10 || Client.gameState == 11) {
					...
					int var43 = MouseHandler.MouseHandler_lastPressedX;
					int var44 = MouseHandler.MouseHandler_lastPressedY;
					if (var5 == 0) {
						var43 = MouseHandler.MouseHandler_x;
						var44 = MouseHandler.MouseHandler_y;
					}
					...
					if (Login.loginIndex == 0) {
						...
						var47 = class485.loginBoxCenter - 80;
						var46 = 291;
						if (var5 == 1 && var43 >= var47 - 75 && var43 <= var47 + 75 && var44 >= var46 - 20 && var44 <= var46 + 20) {
							class27.openURL(Widget.method6509("secure", true) + "m=account-creation/g=oldscape/create_account_funnel.ws", true, false);
						}

						var47 = class485.loginBoxCenter + 80;
						if (var5 == 1 && var43 >= var47 - 75 && var43 <= var47 + 75 && var44 >= var46 - 20 && var44 <= var46 + 20 || var55) {
						...
						if (Login.loginIndex == 1) {
							while (true) {
								if (!var25.method4133()) {
									...
									var10 = 321;
									if (var5 == 1 && var43 >= var9 - 75 && var43 <= var9 + 75 && var44 >= var10 - 20 && var44 <= var10 + 20) {
										ViewportMouse.Login_promptCredentials(false);
									}
							...
							if (Login.loginIndex == 2) {
								var45 = 201;
								var9 = var45 + 52;
								if (var5 == 1 && var44 >= var9 - 12 && var44 < var9 + 2) {
								...
								if (FriendsList.field4572 != null) {
									var47 = FriendsList.field4572.highX / 2;
									if (var5 == 1 && var43 >= FriendsList.field4572.lowX - var47 && var43 <= var47 + FriendsList.field4572.lowX && var44 >= var45 - 15 && var44 < var45) {
								...
								var47 = class485.loginBoxCenter + -117;
								var46 = 277;
								Login.field947 = var43 >= var47 && var43 < var47 + class251.field2858 && var44 >= var46 && var44 < var46 + class60.field443;
								...
								var47 = class485.loginBoxCenter + 24;
								var46 = 277;
								Login.field941 = var43 >= var47 && var43 < var47 + class251.field2858 && var44 >= var46 && var44 < var46 + class60.field443;
								...
								while (true) {
									...
									do {
										while (true) {
												...
												while (true) {
													while (var25.method4133()) {
														if (var25.field2349 != 13) {
															...
															for (var13 = 0; var13 < "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".length() && var49 != "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(var13); ++var13) {
															}
															...
															char var50 = var25.field2348;
															boolean var52 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".indexOf(var50) != -1;
															if (var52 && Login.Login_username.length() < 320) {
											...
											if ((var25.method4134(82) || var25.method4134(87)) && var25.field2349 == 67) {
												...
												var61 = var60.getContents(class347.client);
												var51 = 20 - Login.Login_password.length();
												break;
											}

											if (ClanChannelMember.method3135(var25.field2348)) {
												char var53 = var25.field2348;
												var48 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".indexOf(var53) != -1;
									...
									try {
										String var15 = (String)var61.getTransferData(DataFlavor.stringFlavor);
										...
										while (true) {
											...
											if (var56 >= ' ' && var56 < 127 || var56 > 127 && var56 < 160 || var56 > 160 && var56 <= 255) {
												...
												label1528: {
													if (var56 != 0) {
														char[] var58 = class382.cp1252AsciiExtension;

														for (var21 = 0; var21 < var58.length; ++var21) {
															char var22 = var58[var21];
															if (var22 == var56) {
																var18 = true;
																break label1528;
															}
											...
											char var59 = var15.charAt(var54);
											boolean var28 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".indexOf(var59) != -1;
											if (!var28) {
												break;
											}
								...
								if (Login.loginIndex == 3) {
									...
									if (var5 == 1 && var29.method8029(var43, var44)) {
									...
									if (Login.loginIndex == 4) {
										...
										if (var5 == 1 && var43 >= Login.loginBoxX + 180 - 9 && var43 <= Login.loginBoxX + 180 + 130 && var44 >= 263 && var44 <= 296) {
											Login.field942 = !Login.field942;
										}

										if (var5 == 1 && var43 >= Login.loginBoxX + 180 - 34 && var43 <= Login.loginBoxX + 34 + 180 && var44 >= 351 && var44 <= 363) {
										...
										if (Calendar.field3770 != null) {
											...
											if (var5 == 1 && var43 >= Calendar.field3770.lowX - var12 && var43 <= var12 + Calendar.field3770.lowX && var44 >= var46 - 15 && var44 < var46) {
										...
										if (Login.loginIndex == 7) {
											if (class112.field1401 && !Client.onMobile) {
												...
												var47 = var9 + 40 + 240 + 25;
												var46 = 231;
												var12 = var46 + 40;
												if (var5 == 1 && var43 >= var9 && var43 <= var47 && var44 >= var46 && var44 <= var12) {
													Login.field935 = ArchiveLoader.method2220(var9, var43);
												}
												...
												Date var63;
												if (var5 == 1 && var43 >= var13 - 75 && var43 <= var13 + 75 && var44 >= var14 - 20 && var44 <= var14 + 20) {
													label1222: {
														try {
														...
														if (var34 == null) {
															...
															var62 = java.util.Calendar.getInstance();
															var62.set(1, var62.get(1) - 13);
															var62.set(5, var62.get(5) + 1);
															var62.set(11, 0);
															var62.set(12, 0);
															var62.set(13, 0);
															var62.set(14, 0);
															var63 = var62.getTime();
															var17 = var34.before(var63);
															var36 = java.util.Calendar.getInstance();
															var36.set(2, 0);
															var36.set(5, 1);
															var36.set(1, 1900);
															var57 = var36.getTime();
															var19 = var34.after(var57);
															if (!var19) {
																class390.method7249(7);
																class478.setLoginResponseString("Date not valid.", "Please ensure date follows the format", "DD/MM/YYYY and is after 01/01/1900");
																var35 = false;
											...
											var9 = Login.loginBoxX + 180;
											var10 = 311;
											if (var25.field2349 == 84 || var25.field2349 == 13 || var5 == 1 && var43 >= var9 - 75 && var43 <= var9 + 75 && var44 >= var10 - 20 && var44 <= var10 + 20) {
												class164.method3362(false);
											}
										} else if (Login.loginIndex == 10) {
											var9 = Login.loginBoxX + 180;
											var10 = 209;
											if (var25.field2349 == 84 || var5 == 1 && var43 >= var9 - 109 && var43 <= var9 + 109 && var44 >= var10 && var44 <= var10 + 68) {
												class478.setLoginResponseString("", "Connecting to server...", "");
											...
											var10 = 233;
											var29 = var2.method7425(0, 30, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var9, var10);
											Bounds var26 = var2.method7425(32, 32, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var9, var10);
											Bounds var27 = var2.method7425(70, 34, "<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>", var9, var10);
											var47 = var10 + 17;
											Bounds var37 = var2.method7425(0, 34, "<col=ffd200>agreement (EULA)</col>.", var9, var47);
											if (var5 == 1) {
												if (var29.method8029(var43, var44)) {
													class27.openURL("https://www.jagex.com/terms", true, false);
												} else if (var26.method8029(var43, var44)) {
													class27.openURL("https://www.jagex.com/terms/privacy", true, false);
												} else if (var27.method8029(var43, var44) || var37.method8029(var43, var44)) {
										...
										while (true) {
											do {
												if (!var25.method4133()) {
													var45 = 321;
													if (var5 == 1 && var44 >= var45 - 20 && var44 <= var45 + 20) {
														ViewportMouse.Login_promptCredentials(true);
													}
