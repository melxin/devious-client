...
public class class81 {
	...
	static void resumePauseWidget(int var0, int var1) {
		PacketBufferNode var2 = class330.getPacketBufferNode(ClientPacket.field3173, Client.packetWriter.isaacCipher);
		var2.packetBuffer.method9109(var0);
		var2.packetBuffer.method9132(var1);
