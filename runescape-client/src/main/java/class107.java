...
public class class107 {
	...
	static {
		...
		field1349 = new class107(2);
		field1350 = new class107(3);
		field1351 = new class107(4);
		field1357 = new class107(5);
		field1353 = new class107(6);
		field1348 = new class107(7);
		field1355 = new class107(8);
		field1356 = new class107(9);
		field1352 = new class107(10);
		field1358 = new class107(11);
		field1354 = new class107(12);
		field1360 = new class107(13);
		field1361 = new class107(14);
		field1362 = new class107(15);
	}
	...
	static final int method2701(int var0, int var1) {
		int var2 = GrandExchangeEvents.method6803(var0 + 45365, 91923 + var1, 4) - 128 + (GrandExchangeEvents.method6803(var0 + 10294, 37821 + var1, 2) - 128 >> 1) + (GrandExchangeEvents.method6803(var0, var1, 1) - 128 >> 2);
	...
	static int method2700(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) {
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				PacketBufferNode var13 = ObjectComposition.getPacketBufferNode(ClientPacket.field3118, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					var7 = Interpreter.Interpreter_stringStack[--class149.Interpreter_stringStackSize];
					var11 = ObjectComposition.getPacketBufferNode(ClientPacket.field3124, Client.packetWriter.isaacCipher);
					...
					var7 = Interpreter.Interpreter_stringStack[--class149.Interpreter_stringStackSize];
					var11 = ObjectComposition.getPacketBufferNode(ClientPacket.field3187, Client.packetWriter.isaacCipher);
					var11.packetBuffer.writeByte(var7.length() + 1);
					var11.packetBuffer.writeStringCp1252NullTerminated(var7);
					Client.packetWriter.addNode(var11);
					return 1;
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
						var11 = ObjectComposition.getPacketBufferNode(ClientPacket.field3193, Client.packetWriter.isaacCipher);
