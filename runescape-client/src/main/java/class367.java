...
public class class367 {
	...
	public class367() {
		...
		this.field4324 = new int[2048];
		this.field4326 = new int[2048];
		this.field4328 = 0;
		...
		for (byte var3 = 12; var1 < 16; var2 -= var3) {
			var4 = class60.method1135((double)((float)var2 / 360.0F), 0.9998999834060669D, (double)((float)var1 * 0.425F / 16.0F + 0.075F));
			field4327[var1] = var4;
			++var1;
		}
		...
		for (int var6 = var2 / 6; var1 < field4327.length; var2 -= var6) {
			var4 = var1 * 2;

			for (int var5 = class60.method1135((double)((float)var2 / 360.0F), 0.9998999834060669D, 0.5D); var1 < var4 && var1 < field4327.length; ++var1) {
				field4327[var1] = var5;
			}
		}
	...
	void method6877(int var1) {
		int var2 = var1 * 2 + 1;
		double[] var3 = VertexNormal.method4921(0.0D, (double)((float)var1 / 3.0F), var1);
