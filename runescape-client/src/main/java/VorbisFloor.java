...
public class VorbisFloor {
	...
	static {
		field288 = new int[]{256, 128, 86, 64};
	...
	VorbisFloor() {
		...
		if (var1 != 1) {
			...
			this.field286 = new int[var5];
			this.field286[0] = 0;
			this.field286[1] = 1 << var4;
			var5 = 2;
			...
			for (var6 = 0; var6 < var2; ++var6) {
				...
				for (int var8 = 0; var8 < this.classDimensions[var7]; ++var8) {
					this.field286[var5++] = VorbisSample.readBits(var4);
				}
			}

			if (field284 == null || field284.length < var5) {
				field284 = new int[var5];
				field294 = new int[var5];
				field295 = new boolean[var5];
			}
	...
	void VarbisFloor_sort(int var1, int var2) {
		if (var1 < var2) {
			int var3 = var1;
			int var4 = field284[var1];
			int var5 = field294[var1];
			boolean var6 = field295[var1];

			for (int var7 = var1 + 1; var7 <= var2; ++var7) {
				int var8 = field284[var7];
				if (var8 < var4) {
					field284[var3] = var8;
					field294[var3] = field294[var7];
	...
	boolean readSubmapFloor() {
		...
		if (!var1) {
			...
			int var2 = this.field286.length;

			int var3;
			for (var3 = 0; var3 < var2; ++var3) {
				field284[var3] = this.field286[var3];
			}

			var3 = field288[this.multiplier - 1];
			int var4 = LoginPacket.iLog(var3 - 1);
			field294[0] = VorbisSample.readBits(var4);
			field294[1] = VorbisSample.readBits(var4);
			int var5 = 2;
			...
			for (int var6 = 0; var6 < this.partitionClassList.length; ++var6) {
				...
				int var11 = 0;
				if (var9 > 0) {
					var11 = VorbisSample.VorbisSample_codebooks[this.classMasterbooks[var7]].method1069();
				}

				for (int var12 = 0; var12 < var8; ++var12) {
					int var13 = this.subclassBooks[var7][var11 & var10];
					var11 >>>= var9;
					field294[var5++] = var13 >= 0 ? VorbisSample.VorbisSample_codebooks[var13].method1069() : 0;
				}
			}
	...
	@ObfuscatedName("aq")
	void method794(float[] var1, int var2) {
		int var3 = this.field286.length;
		int var4 = field288[this.multiplier - 1];
		boolean[] var5 = field295;
		field295[1] = true;
		var5[0] = true;
		...
		for (var6 = 2; var6 < var3; ++var6) {
			var7 = method789(field284, var6);
			var8 = method807(field284, var6);
			var9 = this.method790(field284[var7], field294[var7], field284[var8], field294[var8], field284[var6]);
			var10 = field294[var6];
			int var11 = var4 - var9;
			int var13 = (var11 < var9 ? var11 : var9) << 1;
			if (var10 != 0) {
				boolean[] var14 = field295;
				field295[var8] = true;
				var14[var7] = true;
				field295[var6] = true;
				if (var10 >= var13) {
					field294[var6] = var11 > var9 ? var9 + (var10 - var9) : var11 + (var9 - var10) - 1;
				} else {
					field294[var6] = (var10 & 1) != 0 ? var9 - (var10 + 1) / 2 : var10 / 2 + var9;
				}
			} else {
				field295[var6] = false;
				field294[var6] = var9;
		...
		var6 = 0;
		var7 = field294[0] * this.multiplier;

		for (var8 = 1; var8 < var3; ++var8) {
			if (field295[var8]) {
				var9 = field284[var8];
				var10 = field294[var8] * this.multiplier;
				this.method791(var6, var7, var9, var10, var1, var2);
				if (var9 >= var2) {
					return;
				}
	...
	@ObfuscatedName("af")
	static int method789(int[] var0, int var1) {
		int var2 = var0[var1];
		int var3 = -1;
