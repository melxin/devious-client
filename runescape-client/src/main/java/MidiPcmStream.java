...
public class MidiPcmStream extends PcmStream {
	...
	public MidiPcmStream() {
		this.field3416 = 256;
		this.field3394 = 1000000;
		this.field3403 = new int[16];
		this.field3411 = new int[16];
		this.field3397 = new int[16];
		...
		this.field3395 = new int[16];
		this.field3408 = new int[16];
		this.field3409 = new int[16];
		this.field3410 = new int[16];
		this.field3392 = new MusicPatchNode[16][128];
		this.field3412 = new MusicPatchNode[16][128];
	...
	void method5788(int var1, int var2) {
		...
		this.field3410[var1] = (int)(2097152.0D * Math.pow(2.0D, 5.4931640625E-4D * (double)var2) + 0.5D);
	}
	...
	int method5789(MusicPatchNode var1) {
		...
		if (var3.field3380 > 0 && (var3.field3379 > 0 || this.field3399[var1.field3467] > 0)) {
			...
			double var6 = Math.sin(0.01227184630308513D * (double)(var1.field3457 & 511));
			var2 += (int)(var6 * (double)var4);
		}

		var4 = (int)((double)(var1.rawSound.sampleRate * 256) * Math.pow(2.0D, 3.255208333333333E-4D * (double)var2) / (double)(PcmPlayer.field306 * 586337296) + 0.5D);
	...
	int method5790(MusicPatchNode var1) {
		...
		if (var2.field3375 > 0) {
			var3 = (int)((double)var3 * Math.pow(0.5D, (double)var2.field3375 * (double)var1.field3460 * 1.953125E-5D) + 0.5D);
		}
		...
		if (var2.field3374 != null) {
			var4 = var1.field3461;
			var5 = var2.field3374[var1.field3468 * 2 + 1];
			if (var1.field3468 * 2 < var2.field3374.length - 2) {
				var6 = (var2.field3374[var1.field3468 * 2] & 255) << 8;
				var7 = (var2.field3374[var1.field3468 * 2 + 2] & 255) << 8;
				var5 += (var2.field3374[var1.field3468 * 2 + 3] - var5) * (var4 - var6) / (var7 - var6);
			}
	...
	boolean method5798(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3464 < 0 || var1.stream != null && !var1.stream.method988()) {
			...
			if (var5 > 0) {
				var5 -= (int)(16.0D * Math.pow(2.0D, (double)this.field3420[var1.field3467] * 4.921259842519685E-4D) + 0.5D);
				if (var5 < 0) {
					var5 = 0;
				}
			...
			double var8 = 5.086263020833333E-6D * (double)((var1.field3454 - 60 << 8) + (var1.field3458 * var1.field3459 >> 12));
			if (var6.field3375 > 0) {
				if (var6.field3378 > 0) {
			...
			if (var6.field3374 != null) {
				...
				while (var1.field3468 * 2 < var6.field3374.length - 2 && var1.field3461 > (var6.field3374[var1.field3468 * 2 + 2] & 255) << 8) {
					var1.field3468 = var1.field3468 * 4 + 4;
				}

				if (var1.field3468 * 2 == var6.field3374.length - 2 && var6.field3374[var1.field3468 * 2 + 1] == 0) {
					var7 = true;
				}
			}
