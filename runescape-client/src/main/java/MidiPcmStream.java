...
public class MidiPcmStream extends PcmStream {
	...
	public MidiPcmStream() {
		...
		this.field3430 = new int[16];
		this.field3436 = new MusicPatchNode[16][128];
		this.field3428 = new MusicPatchNode[16][128];
		this.midiFile = new MidiFileReader();
		this.patchStream = new MusicPatchPcmStream(this);
		this.field3419 = new PriorityQueue(5, new class306());
	...
	void method5760(int var1, int var2) {
		...
		this.field3430[var1] = (int)(2097152.0D * Math.pow(2.0D, 5.4931640625E-4D * (double)var2) + 0.5D);
	}
	...
	int method5761(MusicPatchNode var1) {
		...
		if (var3.field3372 > 0 && (var3.field3378 > 0 || this.field3414[var1.field3490] > 0)) {
			...
			double var6 = Math.sin((double)(var1.field3492 & 511) * 0.01227184630308513D);
			var2 += (int)((double)var4 * var6);
		}

		var4 = (int)((double)(var1.rawSound.sampleRate * 256) * Math.pow(2.0D, (double)var2 * 3.255208333333333E-4D) / (double)PcmPlayer.field291 + 0.5D);
	...
	int method5762(MusicPatchNode var1) {
		...
		if (var2.field3373 > 0) {
			var3 = (int)((double)var3 * Math.pow(0.5D, (double)var2.field3373 * 1.953125E-5D * (double)var1.field3486) + 0.5D);
		}
	...
	boolean method5771(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field3489 < 0 || var1.stream != null && !var1.stream.method951()) {
			...
			if (var5 > 0) {
				var5 -= (int)(16.0D * Math.pow(2.0D, (double)this.field3420[var1.field3490] * 4.921259842519685E-4D) + 0.5D);
				if (var5 < 0) {
					var5 = 0;
				}
			...
			double var8 = (double)((var1.field3480 - 60 << 8) + (var1.field3485 * var1.field3484 >> 12)) * 5.086263020833333E-6D;
			if (var6.field3373 > 0) {
				if (var6.field3379 > 0) {
