...
public class WorldMapID {
	...
	static {
		field3029 = new WorldMapID(0);
		field3030 = new WorldMapID(1);
	}
	...
	static boolean updateExternalPlayer(PacketBuffer var0, int var1) {
		...
		if (var2 == 0) {
			...
			if (Client.players[var1] != null) {
				...
				var11.resetPath((var9 << 13) + var3 - WorldMapData_0.baseX * 64, (var10 << 13) + var4 - GameObject.baseY * 64);
				var11.field1110 = false;
				return true;
			}
		} else if (var2 == 1) {
	...
	static Frames getFrames(int var0) {
		...
		if (var1 != null) {
			...
			var1 = PendingSpawn.method2360(SequenceDefinition.SequenceDefinition_animationsArchive, SequenceDefinition.SequenceDefinition_skeletonsArchive, var0, false);
			if (var1 != null) {
