	...
	static final void updateNpcs(boolean var0, PacketBuffer var1) {
		...
		for (var2 = 0; var2 < Client.field548; ++var2) {
			...
			if ((var5 & 32) != 0) {
				...
				var4.targetIndex += var1.method9089() << 16;
				var6 = 16777215;
				...
				if (var7 > 0) {
					for (var8 = 0; var8 < var7; ++var8) {
						...
						if (var16 != 32767) {
							...
							int var13 = var16 > 0 ? var1.method9090() : var12;
			...
			if ((var5 & 8) != 0) {
				var4.definition = AbstractArchive.getNpcDefinition(var1.method9099());
			...
			if ((var5 & 16) != 0) {
				var6 = var1.method9098();
				var7 = var1.method9098();
				var4.field1142 = var1.method9089() == 1;
			...
			if ((var5 & 16384) != 0) {
				...
				var4.spotAnimation = var1.method9098() + Client.cycle;
				var4.field1192 = var1.method9135() + Client.cycle;
			...
			if ((var5 & 2048) != 0) {
				var4.field1168 = Client.cycle + var1.method9135();
				var4.field1156 = Client.cycle + var1.readUnsignedShort();
				var4.field1180 = var1.method9186();
				var4.field1199 = var1.method9232();
				var4.field1200 = var1.method9092();
				var4.field1208 = (byte)var1.method9039();
			}
				...
				if ((var6 & 1) == 1) {
					...
					if ((var6 & 4) == 4) {
						...
						for (var16 = 0; var16 < var9; ++var16) {
							var15[var16] = (short)var1.method9135();
						}
					}
					...
					if ((var6 & 8) == 8) {
						...
						for (var11 = 0; var11 < var16; ++var11) {
							var17[var11] = (short)var1.method9098();
						}
					}
			...
			if ((var5 & 1024) != 0) {
				...
				if ((var6 & 1) == 1) {
					...
					var14 = null;
					if ((var6 & 2) == 2) {
						var8 = var1.method9089();
						var14 = new int[var8];

						for (var9 = 0; var9 < var8; ++var9) {
							var16 = var1.method9099();
							var16 = var16 == 65535 ? -1 : var16;
							var14[var9] = var16;
						}
					}
					...
					if ((var6 & 8) == 8) {
						...
						for (var11 = 0; var11 < var16; ++var11) {
							var17[var11] = (short)var1.method9099();
						}
					}
			...
			if ((var5 & 131072) != 0) {
				...
				for (var9 = 0; var9 < 8; ++var9) {
					if ((var6 & 1 << var9) != 0) {
						var14[var9] = var1.method9108();
						var15[var9] = (short)var1.method9073();
					} else {
						var14[var9] = -1;
						var15[var9] = -1;
					}
			...
			if ((var5 & 262144) != 0) {
				...
				var4.walkSequence = (var6 & 4) != 0 ? var1.method9099() : var4.definition.walkSequence;
				...
				var4.field1150 = (var6 & 128) != 0 ? var1.method9135() : var4.definition.field2008;
				var4.field1151 = (var6 & 256) != 0 ? var1.method9135() : var4.definition.field2025;
				var4.field1152 = (var6 & 512) != 0 ? var1.method9135() : var4.definition.field2037;
				...
				var4.field1155 = (var6 & 4096) != 0 ? var1.method9098() : var4.definition.field2029;
				var4.field1157 = (var6 & 8192) != 0 ? var1.method9099() : var4.definition.field2030;
				var4.idleSequence = (var6 & 16384) != 0 ? var1.method9098() : var4.definition.idleSequence;
			}
