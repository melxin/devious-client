			...
			while (true) {
				...
				if (var8 == 0) {
					if (var1 == 0) {
						...
						int var14 = class101.method2691(45365 + var12, 91923 + var13, 4) - 128 + (class101.method2691(10294 + var12, 37821 + var13, 2) - 128 >> 1) + (class101.method2691(var12, var13, 1) - 128 >> 2);
