...
public class HealthBar extends Node {
	...
	static final void method2549() {
		...
		if (Client.oculusOrbState == 0) {
			...
			if (Client.field739.method4134(13)) {
				Client.packetWriter.addNode(ObjectComposition.getPacketBufferNode(ClientPacket.field3192, Client.packetWriter.isaacCipher));
	...
	static void setWindowedMode(int var0) {
		...
		if (Client.gameState >= 25) {
			PacketBufferNode var1 = ObjectComposition.getPacketBufferNode(ClientPacket.field3195, Client.packetWriter.isaacCipher);
