			...
			label953: {
				label954: {
						...
						try {
							...
							while (true) {
								...
								if (var33 >= 100) {
									...
									var14 = class33.method511(var33, var4, var35);
									switch(var14) {
									case 0:
										var30 = false;
										break label937;
										...
										if (var33 == ScriptOpcodes.GET_VARC_INT) {
											...
											if (var33 == ScriptOpcodes.GET_VARC_STRING_OLD) {
												...
												if (var33 == ScriptOpcodes.GET_VARCLANSETTING) {
													var39 = class133.field1597.getTitleGroupValue(var7[var20]);
													if (var39 == null) {
													...
													var39 = Players.field1339.method8280(var7[var20]);
													if (var39 == null) {
														Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = -1;
													} else {
														Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var39;
					...
					while (Interpreter.field837.size() > 0) {
						...
						Message.widgetDefaultMenuAction(var34.method2639(), var34.method2637(), var34.method2638(), var34.method2641(), "");
					}
