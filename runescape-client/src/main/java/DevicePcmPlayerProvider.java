	...
	static void load() {
		...
		if (Client.titleLoadingStage == 0) {
			...
			if (Client.titleLoadingStage == 45) {
				...
				var24.method5772(9, 128);
				class28.pcmPlayer0 = class148.method3290(GameEngine.taskHandler, 0, 22050);
				class28.pcmPlayer0.setStream(var24);
				ParamComposition.method3900(class126.archive15, class230.archive14, class426.field4687, var24);
				...
				if (Client.titleLoadingStage == 60) {
					...
					var23 = class7.textureProvider.getLoadedPercentage();
					if (var23 < 100) {
			...
			byte var12 = 0;
			var23 = var12 + field117.percentage() * 4 / 100;
			var23 += GameBuild.archive7.percentage() * 4 / 100;
			var23 += class85.archive2.percentage() * 2 / 100;
			var23 += class85.archive4.percentage() * 2 / 100;
			var23 += class426.field4687.percentage() * 6 / 100;
			var23 += GrandExchangeOfferTotalQuantityComparator.archive9.percentage() * 4 / 100;
			var23 += class399.archive6.percentage() * 2 / 100;
			var23 += FloorUnderlayDefinition.archive11.percentage() * 55 / 100;
			var23 += class452.archive8.percentage() * 2 / 100;
			var23 += WorldMapLabelSize.field2868.percentage() * 2 / 100;
			var23 += NetFileRequest.archive10.percentage() * 2 / 100;
			var23 += class195.field2101.percentage() * 2 / 100;
			var23 += class126.archive12.percentage() * 2 / 100;
			var23 += class128.archive13.percentage() * 2 / 100;
			var23 += class230.archive14.percentage() * 2 / 100;
			var23 += class126.archive15.percentage() * 2 / 100;
			var23 += class28.archive19.percentage() / 100;
			var23 += GrandExchangeOfferUnitPriceComparator.archive18.percentage() / 100;
			var23 += class205.archive20.percentage() / 100;
			var23 += PcmPlayer.field316.percentage() / 100;
			var23 += class168.archive17.method6635() && class168.archive17.isFullyLoaded() ? 1 : 0;
			if (var23 != 100) {
				if (var23 != 0) {
