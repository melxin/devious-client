...
public class VorbisCodebook {
	...
	VorbisCodebook() {
		...
		var1.method1118(24);
		this.field362 = var1.method1118(16);
		this.entries = var1.method1118(24);
		...
		if (var2) {
			...
			for (var4 = var1.method1118(5) + 1; var3 < this.entries; ++var4) {
				int var5 = var1.method1118(Tile.iLog(this.entries - var3));
			...
			for (var4 = 0; var4 < this.entries; ++var4) {
				if (var15 && var1.method1117() == 0) {
					...
					this.lengthMap[var4] = var1.method1118(5) + 1;
				}
			}
		}

		this.method1025();
		var3 = var1.method1118(4);
		if (var3 > 0) {
			float var16 = VorbisSample.float32Unpack(var1.method1118(32));
			float var17 = VorbisSample.float32Unpack(var1.method1118(32));
			var6 = var1.method1118(4) + 1;
			...
			for (var9 = 0; var9 < var8; ++var9) {
				this.field363[var9] = var1.method1118(var6);
			}
