	...
	static void method2909(int var0, String var1) {
		...
		for (int var6 = 0; var6 < var2; ++var6) {
			...
			if (var7 != null && var7 != MusicPatchNode.localPlayer && var7.username != null && var7.username.equals(var5)) {
				...
				if (var0 == 1) {
					var8 = class330.getPacketBufferNode(ClientPacket.field3127, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method9203(0);
					var8.packetBuffer.writeShort(var3[var6]);
					Client.packetWriter.addNode(var8);
				} else if (var0 == 4) {
					var8 = class330.getPacketBufferNode(ClientPacket.field3160, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method9114(0);
					var8.packetBuffer.method9132(var3[var6]);
					Client.packetWriter.addNode(var8);
				} else if (var0 == 6) {
					var8 = class330.getPacketBufferNode(ClientPacket.field3155, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method9096(var3[var6]);
					var8.packetBuffer.method9114(0);
					Client.packetWriter.addNode(var8);
				} else if (var0 == 7) {
					var8 = class330.getPacketBufferNode(ClientPacket.field3116, Client.packetWriter.isaacCipher);
					var8.packetBuffer.method9257(var3[var6]);
					var8.packetBuffer.method9086(0);
					Client.packetWriter.addNode(var8);
				}
