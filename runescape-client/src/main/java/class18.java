...
public class class18 {
	...
	static final void drawEntities(int var0, int var1, int var2, int var3) {
		...
		if (Client.oculusOrbState == 1 && Client.staffModLevel >= 2 && Client.cycle % 50 == 0 && (class33.oculusOrbFocalPointX >> 7 != MusicPatchNode.localPlayer.x >> 7 || class144.oculusOrbFocalPointY >> 7 != MusicPatchNode.localPlayer.y >> 7)) {
			...
			var19.packetBuffer.method9043(Client.field576);
			var19.packetBuffer.method9096(var17);
			var19.packetBuffer.method9086(var16);
			var19.packetBuffer.method9257(var18);
		...
		for (var16 = 0; var16 < 5; ++var16) {
			if (Client.field753[var16]) {
				var17 = (int)(Math.random() * (double)(Client.field754[var16] * 2 + 1) - (double)Client.field754[var16] + Math.sin((double)Client.field584[var16] * ((double)Client.field631[var16] / 100.0D)) * (double)Client.field776[var16]);
				if (var16 == 0) {
