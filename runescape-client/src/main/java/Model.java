...
public class Model extends Renderable {
	...
	static {
		...
		field2689 = new class425();
		field2690 = new class425();
		field2691 = new class425();
		field2724 = new boolean[6500];
		field2725 = new boolean[6500];
		modelViewportXs = new int[6500];
		modelViewportYs = new int[6500];
		field2728 = new float[6500];
		field2729 = new int[6500];
		field2716 = new int[6500];
		field2731 = new int[6500];
		field2760 = new int[6500];
		field2754 = new char[6000];
		field2735 = new char[6000][512];
		field2736 = new int[12];
		field2700 = new int[12][2000];
		field2738 = new int[2000];
		field2739 = new int[2000];
		field2740 = new int[12];
		field2741 = new int[10];
		field2742 = new int[10];
		field2743 = new int[10];
		field2705 = new float[10];
		field2737 = true;
		...
		if (this.diameter < 6000) {
				...
				if (this.faceColors3[var7] != -2) {
					...
					if (!var1 || var11 != -5000 && var12 != -5000 && var28 != -5000) {
						...
						if ((var11 - var12) * (modelViewportYs[var10] - modelViewportYs[var9]) - (var28 - var12) * (modelViewportYs[var8] - modelViewportYs[var9]) > 0) {
							...
							field2735[var15][field2754[var15]++] = var7;
						}
					} else {
						...
						if (var15 * var23 + var18 * var24 + var21 * var25 > 0) {
							...
							field2735[var26][field2754[var26]++] = var7;
						}
					}
				}
			}
			...
			if (this.faceRenderPriorities == null) {
				for (var31 = this.diameter - 1; var31 >= 0; --var31) {
					var32 = field2754[var31];
					if (var32 > 0) {
						var27 = field2735[var31];
				...
				for (var31 = this.diameter - 1; var31 >= 0; --var31) {
					...
					if (var32 > 0) {
						...
						for (var10 = 0; var10 < var32; ++var10) {
							...
							var28 = field2736[var34]++;
							field2700[var34][var28] = var33;
							if (var34 < 10) {
								int[] var36 = field2740;
								var36[var34] += var31;
							} else if (var34 == 10) {
	...
	final void method4780(int var1, int var2, int var3, int var4, int var5, int var6, int var7, float var8, float var9, float var10, int var11, int var12, int var13) {
		...
		if (this.faceTextures != null && this.faceTextures[var1] != -1) {
			...
			if (this.textureFaces != null && this.textureFaces[var1] != -1) {
				int var23 = this.textureFaces[var1] & 255;
				var20 = this.texIndices1[var23];
				var21 = this.texIndices2[var23];
				var22 = this.texIndices3[var23];
			} else {
			...
			if (this.faceColors3[var1] == -1) {
				DevicePcmPlayerProvider.method322(var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var11, var11, field2716[var20], field2716[var21], field2716[var22], field2731[var20], field2731[var21], field2731[var22], field2760[var20], field2760[var21], field2760[var22], this.faceTextures[var1]);
			} else {
				DevicePcmPlayerProvider.method322(var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, field2716[var20], field2716[var21], field2716[var22], field2731[var20], field2731[var21], field2731[var22], field2760[var20], field2760[var21], field2760[var22], this.faceTextures[var1]);
			}
		} else {
			...
			if (this.faceColors3[var1] == -1 && var14) {
				var21 = field2695[this.faceColors1[var1]];
				var16 = this.overrideHue;
				var17 = this.overrideSaturation;
				var18 = this.overrideLuminance;
				byte var19 = this.overrideAmount;
				Rasterizer3D.field2519.method4512(var2, var3, var4, var5, var6, var7, var8, var9, var10, var21, var16, var17, var18, var19);
				...
				Rasterizer3D.field2519.method4478(var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var15, var16, var17, var18);
			} else {
		...
		if (var4 == 4) {
			...
			if (this.faceTextures != null && this.faceTextures[var1] != -1) {
				...
				if (this.faceColors3[var1] == -1) {
					...
					DevicePcmPlayerProvider.method322(var14, var15, var16, var11, var12, var13, var17, var18, var19, field2743[0], field2743[1], field2743[2], field2716[var38], field2716[var22], field2716[var23], field2731[var38], field2731[var22], field2731[var23], field2760[var38], field2760[var22], field2760[var23], var41);
					DevicePcmPlayerProvider.method322(var14, var16, field2742[3], var11, var13, field2741[3], var17, var19, field2705[3], field2743[0], field2743[2], field2743[3], field2716[var38], field2716[var22], field2716[var23], field2731[var38], field2731[var22], field2731[var23], field2760[var38], field2760[var22], field2760[var23], var41);
				}
			} else {
				...
				if (this.faceColors3[var1] == -1 && var21) {
					...
					Rasterizer3D.field2519.method4512(var14, var15, var16, var11, var12, var13, var17, var18, var19, var22, var39, var40, var25, var26);
					int var42 = field2742[3];
					int var43 = field2741[3];
					float var44 = field2705[3];
					...
					Rasterizer3D.field2519.method4512(var14, var16, var42, var11, var13, var43, var17, var19, var44, var22, var45, var46, var47, var48);
				} else if (this.faceColors3[var1] == -1) {
					var22 = field2695[this.faceColors1[var1]];
					...
					Rasterizer3D.field2519.method4478(var14, var15, var16, var11, var12, var13, var17, var18, var19, var22, var23, var24, var25, var26, var27, var28);
