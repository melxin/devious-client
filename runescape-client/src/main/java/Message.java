		...
		if (var5 != null) {
			...
			if (var11) {
				...
				if (var7) {
					...
					if (var0 == 1) {
						var10 = class330.getPacketBufferNode(ClientPacket.field3190, Client.packetWriter.isaacCipher);
					...
					if (var0 == 2) {
						var10 = class330.getPacketBufferNode(ClientPacket.field3168, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 3) {
						var10 = class330.getPacketBufferNode(ClientPacket.field3174, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 4) {
						var10 = class330.getPacketBufferNode(ClientPacket.field3104, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 5) {
						var10 = class330.getPacketBufferNode(ClientPacket.field3146, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 6) {
						var10 = class330.getPacketBufferNode(ClientPacket.field3169, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 7) {
						var10 = class330.getPacketBufferNode(ClientPacket.field3192, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 8) {
						var10 = class330.getPacketBufferNode(ClientPacket.field3161, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 9) {
						var10 = class330.getPacketBufferNode(ClientPacket.field3124, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
					...
					if (var0 == 10) {
						var10 = class330.getPacketBufferNode(ClientPacket.field3167, Client.packetWriter.isaacCipher);
						var10.packetBuffer.writeInt(var1);
						var10.packetBuffer.writeShort(var2);
						var10.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var10);
