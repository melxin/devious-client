...
public class class452 extends class455 {
	...
	public class452(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
		...
		if ((var5 - var8) * (var7 - var1) == (var4 - var7) * (var8 - var2)) {
			...
			this.field4789 = Math.sqrt(Math.pow(this.field4790 - (double)var1, 2.0D) + Math.pow(this.field4788 - (double)var2, 2.0D));
			...
			if (!var25) {
				this.field4785 += (double)(this.field4792 - this.field4785 > 0.0D ? 2 : -2) * 3.141592653589793D;
			}
