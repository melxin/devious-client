...
public class class354 {
	...
	public class354() {
		...
		this.field4302 = new int[2048];
		this.field4305 = new int[2048];
		this.field4304 = 0;
		...
		for (byte var3 = 12; var1 < 16; var2 -= var3) {
			var4 = UserComparator7.method2910((double)((float)var2 / 360.0F), 0.9998999834060669D, (double)((float)var1 * 0.425F / 16.0F + 0.075F));
		...
		for (int var6 = var2 / 6; var1 < class86.field1073.length; var2 -= var6) {
			var4 = var1 * 2;

			for (int var5 = UserComparator7.method2910((double)((float)var2 / 360.0F), 0.9998999834060669D, 0.5D); var1 < var4 && var1 < class86.field1073.length; ++var1) {
	...
	void method6896(int var1) {
		...
		for (int var9 = 0; var8 <= var1; ++var9) {
			var7[var9] = KeyHandler.method390((double)var8, 0.0D, var4);
			++var8;
		}
